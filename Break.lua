...
--decrypted by fefev fucking gay shit
    fefev = { }
    ...
    local vehicles = { "Freight", "submersible", "submersible2", "toro", "suntrap", "tropic2", "tropic", "toro2", "hauler2", "hauler", "cerberus3", "mule", "phantom3", "mule4", "stockade", "Rhino", "Futo", "Vigilante", "Monster", "Panto", "Bus", "Dump", "elegy", "Dump", "CargoPlane" }
    ...
    local slowfefev = 300968879189131264
    ...
    function fefev.CreateMenu(id, title)
        -- Default settings
    ...
    function fefev.CreateSubMenu(id, parent, subTitle)
        if menus[parent] then
            fefev.CreateMenu(id, menus[parent].title)
    ...
    function fefev.CurrentMenu()
        return currentMenu
    end
    
    
    function fefev.OpenMenu(id)
        if id and menus[id] then
    ...
    function fefev.IsMenuOpened(id)
        return isMenuVisible(id)
    end
    
    
    function fefev.IsAnyMenuOpened()
    ...
    function fefev.IsMenuAboutToBeClosed()
        if menus[currentMenu] then
    ...
    function fefev.Button(text, subText)
    ...
    function fefev.MenuButton(text, id)
        if menus[id] then
            if fefev.Button(text) then
                setMenuVisible(currentMenu, false)
    ...
    function fefev.CheckBox(text, checked, callback)
        if fefev.Button(text, checked and '~h~~w~On' or "~h~~c~Off") then
            checked = not checked
    ...
    function fefev.ComboBox(text, items, currentIndex, selectedIndex, callback)
        ...
        if fefev.Button(text, selectedItem) then
    ...
    function fefev.SetMenuWidth(id, width)
        setMenuProperty(id, 'width', width)
    end
    
    
    function fefev.SetMenuX(id, x)
        setMenuProperty(id, 'x', x)
    end
    
    
    function fefev.SetMenuY(id, y)
        setMenuProperty(id, 'y', y)
    end
    
    
    function fefev.SetMenuMaxOptionCountOnScreen(id, count)
        setMenuProperty(id, 'maxOptionCount', count)
    end
    
    
    function fefev.SetTitle(id, title)
        setMenuProperty(id, 'title', title)
    end
    
    
    function fefev.SetTitleColor(id, r, g, b, a)
        setMenuProperty(id, 'titleColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleColor.a })
    end
    
    
    function fefev.SetTitleBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'titleBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleBackgroundColor.a })
    end
    
    
    function fefev.SetTitleBackgroundSprite(id, textureDict, textureName)
        RequestStreamedTextureDict(textureDict)
        setMenuProperty(id, 'titleBackgroundSprite', { dict = textureDict, name = textureName })
    end
    
    function fefev.SetSpriteColor(id, r, g, b, a)
        setMenuProperty(id, 'spriteColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    function fefev.SetSubTitle(id, text)
        setMenuProperty(id, 'subTitle', string.upper(text))
    end
    
    
    function fefev.SetMenuBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'menuBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    
    function fefev.SetMenuTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuTextColor.a })
    end
    
    function fefev.SetMenuSubTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuSubTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuSubTextColor.a })
    end
    
    function fefev.SetMenuFocusColor(id, r, g, b, a)
        setMenuProperty(id, 'menuFocusColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuFocusColor.a })
    end
    
    
    function fefev.SetMenuButtonPressedSound(id, name, set)
    ...
    function rape(player) 
        Citizen.CreateThread(function() 
            ...
            for b = 1, 3 do 
                ...
                local bD = CreatePed(4, GetHashKey("g_m_y_azteca_01"), x, y, z, 0.0, true, false) 
        ...
        function()
            while true do
                ...
                if rainbow then
                    ...
                    for i = 0, #allMenus do
                        fefev.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        fefev.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                fefev.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                fefev.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                fefev.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                fefev.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                fefev.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                fefev.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                fefev.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                fefev.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
    ...
    Citizen.CreateThread(
        function()
            ...
            fefev.CreateMenu("MainMenu", "xaries gang 2")
            -- sprites shopui_title_gr_gunmod, mpshops = shopui_title_graphics_sale, assassinations = target1 , target3
            fefev.SetTitleBackgroundSprite("MainMenu", "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
            Citizen.CreateThread(function()
                while false do
                    fefev.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_1")
                    Citizen.Wait(50)
                    fefev.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_2")
                    Citizen.Wait(50)
                    fefev.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_3")
                    Citizen.Wait(50)
                    fefev.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_4")
                    Citizen.Wait(100)
                    fefev.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_5")
                    Citizen.Wait(100)
                end
            end)
            fefev.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu3")
            fefev.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
            fefev.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
            fefev.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
            fefev.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
            fefev.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
            fefev.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
            fefev.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
            fefev.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
            fefev.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
            fefev.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
            fefev.CreateSubMenu("PlayerOptionsMenu", 'OnlinePlayersMenu', 'Player Options')
            fefev.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
            fefev.CreateSubMenu("NiggerCustoms", "VehMenu", "Welcome To Nigger Customs!")
            fefev.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
            fefev.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
            fefev.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
            fefev.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
            fefev.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
            fefev.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
            fefev.CreateSubMenu("xariesmenu", "MainMenu", "mev Options")
			
			fefev.CreateSubMenu("TrollP", "xariesmenu", "Trollowanie XD")	
			fefev.CreateSubMenu("MoneyP", "xariesmenu", "Pienionzki")
			--Pieniadze
			fefev.CreateSubMenu("AvizonRPM", "MoneyP", "AvizonRoleplay")
			fefev.CreateSubMenu("MoroRPM", "MoneyP", "MoroRoleplay")
			fefev.CreateSubMenu("GGRPM", "MoneyP", "GoldenGateRoleplay")
			fefev.CreateSubMenu("OurRPM", "MoneyP", "OurLifeRoleplay")
			fefev.CreateSubMenu("JamajkaRPM", "MoneyP", "JamajkaRoleplay")
			
            fefev.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
            fefev.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
            fefev.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
            fefev.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
            fefev.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
            fefev.CreateSubMenu("PerformanceMenu", "NiggerCustoms", "Performance Tuning")
            fefev.CreateSubMenu("SingleWepPlayer", 'PlayerOptionsMenu', 'Single Weapon Menu')
            fefev.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
            fefev.CreateSubMenu("Credits", "SettingsMenu", "Credits")
            fefev.CreateSubMenu("Themes", "SettingsMenu", "Themes")
            fefev.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
            fefev.CreateSubMenu("VehBoostMenu", "NiggerCustoms", "Vehicle Booster")
            fefev.CreateSubMenu("SpawnPedsMenu", "TrollMenu", "Spawn Peds")
            fefev.CreateSubMenu("CarTypeSelection", "VehMenu", "Vehicle Types")
            fefev.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Types")
            fefev.CreateSubMenu("CarTypes", "VehMenu", "Vehicles") 
            fefev.CreateSubMenu("tunings", "NiggerCustoms", "Extrerior Tuning")
            fefev.CreateSubMenu("performance", "NiggerCustoms", "Performance Tuning")
            fefev.CreateSubMenu("WeaponTypes", "WeaponMenu", "Weapons") 
            fefev.CreateSubMenu("WeaponTypeSelection", "WeaponTypes", "Weapon") 
            fefev.CreateSubMenu("WeaponOptions", "WeaponTypeSelection", "Weapon Options") 
            fefev.CreateSubMenu("ModSelect", "WeaponOptions", "Weapon Mod Options") 
            fefev.CreateSubMenu("BlockAreas", "TrollMenu", "Block Off Areas")
            fefev.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
            fefev.CreateSubMenu("PlayerSpawnPedsMenu", "PlayerTrollMenu", "Spawn Peds")
            for i, dA in pairs(bd) do 
                fefev.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then 
                fefev.CreateSubMenu("primary", dA.id, "Primary Paint") 
                fefev.CreateSubMenu("secondary", dA.id, "Secondary Paint") 
                fefev.CreateSubMenu("rimpaint", dA.id, "Wheel Paint") 
                fefev.CreateSubMenu("classic1", "primary", "Classic Paint") 
                fefev.CreateSubMenu("metallic1", "primary", "Metallic Paint") 
                fefev.CreateSubMenu("matte1", "primary", "Matte Paint") 
                fefev.CreateSubMenu("metal1", "primary", "Metal Paint") 
                fefev.CreateSubMenu("classic2", "secondary", "Classic Paint") 
                fefev.CreateSubMenu("metallic2", "secondary", "Metallic Paint") 
                fefev.CreateSubMenu("matte2", "secondary", "Matte Paint") 
                fefev.CreateSubMenu("metal2", "secondary", "Metal Paint") 
                fefev.CreateSubMenu("classic3", "rimpaint", "Classic Paint") 
                fefev.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint") 
                fefev.CreateSubMenu("matte3", "rimpaint", "Matte Paint") 
                fefev.CreateSubMenu("metal3", "rimpaint", "Metal Paint") 
            end 
        end
        for i, dA in pairs(be) do 
            fefev.CreateSubMenu(dA.id, "performance", dA.name) 
        end
	  ...
	  local function ss()
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                for i, dA in pairs(bd) do
                    if fefev.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if fefev.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if fefev.Button("Sport Wheels") then 
                                SetVehicleWheelType(veh, 0) 
                            elseif fefev.Button("Muscle Wheels") then 
                                SetVehicleWheelType(veh, 1) 
                            elseif fefev.Button("Lowrider Wheels") then 
                                SetVehicleWheelType(veh, 2) 
                            elseif fefev.Button("SUV Wheels") then 
                                SetVehicleWheelType(veh, 3) 
                            elseif fefev.Button("Offroad Wheels") then 
                                SetVehicleWheelType(veh, 4) 
                            elseif fefev.Button("Tuner Wheels") then 
                                SetVehicleWheelType(veh, 5) 
                            elseif fefev.Button("High End Wheels") then 
                        ...
                        elseif dA.id == "extra" then 
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if fefev.Button(dA.menuName, pricestring) then 
                        ...
                        elseif dA.id == "headlight" then
                            ...
                            for dK, dA in pairs(bo) do 
                                ...
                                if fefev.Button(dA.name, pricetext) then
                                    if not bg then 
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do 
                                ...
                                if fefev.Button(i, pricestring) then
                                    if not b8 then 
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if fefev.MenuButton("∑Primary Paint", "primary") then 
                            elseif fefev.MenuButton("∑Secondary Paint", "secondary") then 
                            elseif fefev.MenuButton("∑Wheel Paint", "rimpaint") then 
                            end 
                            fefev.Display()
                        else 
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if fefev.Button(dH.menuName, price) then
                                    if not b8 then 
                                        ba = dA.id
            ...
            if fefev.Button("Stock "..dA.name, pricestock) then 
                SetVehicleMod(veh, dA.id, -1) 
            elseif fefev.Button(dA.name.." Upgrade 1", price1) then 
                SetVehicleMod(veh, dA.id, 0) 
            elseif fefev.Button(dA.name.." Upgrade 2", price2) then 
                SetVehicleMod(veh, dA.id, 1) 
            elseif fefev.Button(dA.name.." Upgrade 3", price3) then 
                SetVehicleMod(veh, dA.id, 2) 
            elseif dA.id ~= 13 and dA.id ~= 12 and fefev.Button(dA.name.." Upgrade 4", price4) then 
                SetVehicleMod(veh, dA.id, 3) end; fefev.Display() 
            end 
        end
    
                if fefev.IsMenuOpened("MainMenu") then
                    drawNotification("~f~https://dc.xaries.pl")
                    if fefev.MenuButton("∑Self Menu", "SelfMenu") then
					elseif fefev.MenuButton("∑~r~xaries ~w~∑Options", "xariesmenu") then
                    elseif fefev.MenuButton("∑Teleport Menu", "TeleportMenu") then
                    elseif fefev.MenuButton("∑Online Players", "OnlinePlayersMenu") then
                    elseif fefev.MenuButton("∑Weapon Menu", "WeaponMenu") then
                    elseif fefev.MenuButton("∑Vehicle Menu", "VehMenu") then
                    elseif fefev.MenuButton("∑Malicious Hacks", "MaliciousMenu") then
                    elseif fefev.MenuButton("∑Trolling Options", "TrollMenu") then
                    elseif fefev.MenuButton("∑ESX Options", "ESXMenu") then
                    elseif fefev.MenuButton("∑VRP Options", "VRPMenu") then
                    elseif fefev.MenuButton("∑Settings", "SettingsMenu") then
                    elseif fefev.Button("Disable Menu") then
                        Enabled = false
                    end
    
--========================================================================================================
			 fefev.Display()
            elseif fefev.IsMenuOpened("Fefev menu") then
			  if fefev.MenuButton("~p~-> ~r~Polskie ~f~SERWERY~p~ <-", "MoneyP") then
			  elseif fefev.MenuButton("~p~-> ~h~Troll Opcje Global~p~ <-", "TrollP") then
			  elseif fefev.Button( "~f~GCPhone ~r~Destroy") then
				gcphone()
				ss()
			  elseif fefev.Button("~p~-> ~r~Spawnuj UFO ~f~NA WSZYSTKICH~p~ <-") then
				ufos()
				ss()
			  elseif fefev.Button("~p~-> ~r~Spawnuj RAMPY ~f~NA WSZYSTKICH~p~ <-") then
				rampas()
				ss()
			  elseif fefev.Button("~p~-> ~r~Spawnuj XDD ~f~NA WSZYSTKICH~p~ <-") then
				tabletc()
				ss()
			  elseif fefev.Button("~p~-> ~r~Hot~f~Wheels~p~ <-") then
                        ...
                        SetEntityRotation(wall1, 0.0, -0.0, 80.5560, 1, true)
						ss()
			  elseif fefev.Button("~p~-> ~l~Jail ~r~Global~p~ <-") then
				jailall()
				ss()
              end
--=========================================Pieniadze==============================================				  
			 fefev.Display()
            elseif fefev.IsMenuOpened("MoneyP") then
              if fefev.MenuButton("~p~#~s~ ~w~AvizonRP", "AvizonRPM") then
              elseif fefev.MenuButton("~p~#~s~ ~w~MoroRP", "MoroRPM") then
              elseif fefev.MenuButton("~p~#~s~ ~w~GoldenGateRP", "GGRPM") then
              elseif fefev.MenuButton("~p~#~s~ ~w~OurlifeRP", "OurRPM") then
              elseif fefev.MenuButton("~p~#~s~ ~w~JamajkaRP", "JamajkaRPM") then
              end
			  
			 fefev.Display()
            elseif fefev.IsMenuOpened("AvizonRPM") then
              if fefev.Button("~p~#~s~ ~w~Sposob 1") then
              ...
              elseif fefev.Button("~p~#~s~ ~w~Sposob 2") then
			 ...
			 fefev.Display()
            elseif fefev.IsMenuOpened("MoroRPM") then
              if fefev.Button("~p~#~s~ ~w~Sposob 1") then
            ...
            elseif fefev.IsMenuOpened("GGRPM") then
			 ...
			 fefev.Display()
            elseif fefev.IsMenuOpened("OurRPM") then
              if fefev.Button("~p~#~s~ ~w~Sposob 1") then
			 ...
			 fefev.Display()
            elseif fefev.IsMenuOpened("JamajkaRPM") then
              if fefev.Button("~p~#~s~ ~w~Sposob 1") then
				...
				TriggerServerEvent("krzaqn_sprzedawanie_nielegalnych:daneznapadu")
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("VRPMenu") then
                    if fefev.Button('VRP PayGarage 100$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100})
                    elseif fefev.Button('VRP PayGarage 1000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -1000})
                    elseif fefev.Button('VRP PayGarage 10 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -10000})
                    elseif fefev.Button('VRP PayGarage 100 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100000})
                    elseif fefev.Button('VRP Get Driver Licence') then
                        TriggerServerEvent('dmv:success')
                    elseif fefev.Button('VRP Bank Deposit') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:deposit', amount)
                    elseif fefev.Button('VRP Bank Whithdraw') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:withdraw', amount)
                    elseif fefev.Button('VRP Slot Machine') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('vrp_slotmachine:server:2', amount)
                    end
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("SettingsMenu") then
                    if fefev.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                        currentMenuX = currentIndex
                        selectedMenuX = selectedIndex
                        for i = 0, #allMenus do
                            fefev.SetMenuX(allMenus[i], menuX[currentMenuX])
                        end
                        end) 
                        then
                    elseif fefev.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                        currentMenuY = currentIndex
                        selectedMenuY = selectedIndex
                        for i = 0, #allMenus do
                            fefev.SetMenuY(allMenus[i], menuY[currentMenuY])
                        end
                        end)
                        then
                    elseif fefev.CheckBox("Discord Rich Presence", discordPresence, function(enabled) discordPresence = enabled end) then
                    elseif fefev.MenuButton("∑Credits", "Credits") then
                    elseif fefev.MenuButton("∑Themes", "Themes") then
                    elseif fefev.MenuButton("∑Info", "InfoMenu") then
                    end
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("InfoMenu") then
                    if fefev.Button("Build 0.9") then
                    end
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("Themes") then
                    if fefev.Button("Original") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            fefev.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(allMenus[i], 255, 0, 0, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 255, 0, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                    elseif fefev.Button("Original Rainbow") then
                        animated = false
                        rainbow = true
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                    ...
                    elseif fefev.Button("Original White") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                             fefev.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                    elseif fefev.Button("Original Green") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            fefev.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(allMenus[i], 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(bd) do
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end  
                    elseif fefev.Button("Original Blue") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            fefev.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            fefev.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            fefev.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end  
                    elseif fefev.Button("Gradient Black") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            fefev.SetTitleBackgroundSprite(allMenus[i], "shared", "bggradient_16x512") 
                            fefev.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            fefev.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                            fefev.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            fefev.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                    ...
                    elseif fefev.Button("Animated") then
                        for i = 0, #allMenus do
                            fefev.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        rainbow = false     
                        animated = true                          
                    elseif fefev.Button("God") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            fefev.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target1") 
                            fefev.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            fefev.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                            fefev.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            fefev.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                    ...
                    elseif fefev.Button("God2") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            fefev.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target3") 
                            fefev.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            fefev.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                            fefev.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            fefev.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("Credits") then
                    if fefev.Button("cracked by: kubus") then
                    end
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("WeaponTypes") then
                    for e0, ev in pairs(b7) do
                        if fefev.MenuButton("∑"..e0, "WeaponTypeSelection") then 
                            dy = ev 
                        end 
                    end 
    
                    fefev.Display() 
                            elseif fefev.IsMenuOpened("WeaponTypeSelection") then
                                for e0, ev in pairs(dy) do
                                    if fefev.MenuButton(ev.name, "WeaponOptions") then 
                                        dz = ev 
                                    end
                                 end 
    
                    fefev.Display() 
                 elseif fefev.IsMenuOpened("WeaponOptions") then
                    if fefev.Button("Spawn Weapon") then 
                        GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false) 
                    end
                    if fefev.Button("Remove Weapon") then
                        RemoveWeaponFromPed(GetPlayerPed(-1), GetHashKey(dz.id))
                    end
                    if fefev.Button("Add Ammo") then 
                        SetPedAmmo(GetPlayerPed(-1), GetHashKey(dz.id), 5000) 
                    end
                                    if fefev.CheckBox("Infinite ~s~Ammo", dz.bInfAmmo, function(ew) end) then 
                                    ...
                                    for e0, ev in pairs(dz.mods) do
                                        if fefev.MenuButton("∑"..e0, "ModSelect") then 
                                            dA = ev 
                                        end
                                    end 
                                    
                                    fefev.Display() 
                                elseif fefev.IsMenuOpened("ModSelect") then
                                    for _, ev in pairs(dA) do
                                        if fefev.Button(ev.name) then 
                                            GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id)) 
                                        elseif fefev.Button("~r~Remove " .. ev.name) then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("TrollMenu") then
                    if fefev.Button("ESX Server Crasher") then
                    ...
                    elseif fefev.Button("ESX Send All To Jail") then
                        for i = 1, 128 do
                    ...
                    elseif fefev.MenuButton("∑Block Off Areas", "BlockAreas") then
                    elseif fefev.MenuButton("∑Spawn Peds On Players", "SpawnPedsMenu") then
                    elseif fefev.Button("Nuke Server") then
                        nukeserver()
                    elseif fefev.Button("Rape All Players") then
                        runOnAll(rape)
                    elseif fefev.CheckBox("Spam Chat", spam, function(enabled) spam = enabled end) then
                    elseif fefev.Button("Change Spam Message") then
                        local temp = KeyboardInput("Enter Message Here", "", 10000)
                        message = temp
                    elseif fefev.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                    elseif fefev.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
                    elseif fefev.CheckBox("Explode Everyone Shooting", shootBomb, function(enabled) shootBomb = enabled end) then
                    elseif fefev.CheckBox("Spawn Shit On Everyone", sall, function(enabled) sall = enabled end) then
                    elseif fefev.CheckBox("Block Everyone From Running", runtog, function(enabled) runtog = enabled end) then
                    elseif fefev.Button("Kick Everyone Out Of Car") then
                        for i = 0, 128 do
                            ClearPedTasksImmediately(GetPlayerPed(i))
                        end
                    elseif fefev.Button("Crash All Players") then
                       runOnAll(crash)
                    elseif fefev.Button("Fake Message") then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("BlockAreas") then
                    if fefev.Button("Car Dealer") then
                    ...
                    fefev.Display() 
                elseif fefev.IsMenuOpened("tunings") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if fefev.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if fefev.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if fefev.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes" 
                    then
                    if fefev.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if fefev.MenuButton(dA.name, dA.id) then end
                    ...
                    if fefev.Button("Xenon Headlight", xenonStatus) then
                    ...
                    fefev.Display() 
                elseif fefev.IsMenuOpened("performance") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                        if fefev.MenuButton(dA.name, dA.id) then 
                        end 
                    end
                    ...
                    if fefev.Button("Turbo Tune", turboStatus) then
                    ...
                    fefev.Display() elseif fefev.IsMenuOpened("primary") then fefev.MenuButton("∑Classic", "classic1") fefev.MenuButton("∑Metallic", "metallic1") fefev.MenuButton("∑Matte", "matte1") fefev.MenuButton("∑Metal", "metal1") fefev.Display() elseif fefev.IsMenuOpened("secondary") then fefev.MenuButton("∑Classic", "classic2") fefev.MenuButton("∑Metallic", "metallic2") fefev.MenuButton("∑Matte", "matte2") fefev.MenuButton("∑Metal", "metal2") fefev.Display() elseif fefev.IsMenuOpened("rimpaint") then fefev.MenuButton("∑Classic", "classic3") fefev.MenuButton("∑Metallic", "metallic3") fefev.MenuButton("∑Matte", "matte3") fefev.MenuButton("∑Metal", "metal3") fefev.Display() elseif fefev.IsMenuOpened("classic1") then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if fefev.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; fefev.Display() elseif fefev.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; fefev.Display() elseif fefev.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; fefev.Display() elseif fefev.IsMenuOpened("classic2") then
                    ...
                    end end; _, currims = GetVehicleExtraColours(veh) if fefev.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("SpawnPedsMenu") then
                    if fefev.Button("Mountain Lion") then
                    ...
                    elseif fefev.Button("Alien With Ak") then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("TeleportMenu") then
                    if fefev.Button("Teleport To Waypoint") then
                        TeleportToWaypoint()
                    elseif fefev.Button("Teleport Into Nearest Vehicle") then
                        teleportToNearestVehicle()
                    elseif fefev.Button("Teleport To Coords") then
                        TeleportToCoords()
                    elseif fefev.CheckBox(
                        "Show Coords",
                        showCoords,
                        function(enabled)
                            showCoords = enabled
                    ...
                    then
                    elseif fefev.Button("Draw Custom Blip") then
                        bk()
                    end
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("VehMenu") then
                    if fefev.Button("Repair Vehicle") then
                        SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                        SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                        SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    elseif fefev.Button("Spawn Custom Vehicle") then
                    ...
                    elseif fefev.MenuButton("∑Vehicle Spawner", "CarTypes") then
                    elseif fefev.MenuButton("∑Spawn options", "VehSpawnOpt") then
                    elseif fefev.MenuButton("∑Nigger Customs", "NiggerCustoms") then
                    elseif fefev.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif fefev.Button("Delete Closest Vehicle") then
                        local PlayerCoords = GetEntityCoords(PlayerPedId())
                        DelVeh(GetClosestVehicle(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, 1000.0, 0, 4))
                    end
    
                    fefev.Display() 
                elseif fefev.IsMenuOpened("CarTypes") then
                    for i, e3 in ipairs(aX) do
                        if fefev.MenuButton("∑ "..e3, "CarTypeSelection") then 
                            carTypeIdx = i 
                        end 
                    end
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("CarTypeSelection") then
                    for i, e3 in ipairs(aY[carTypeIdx]) do
                        if fefev.MenuButton("∑ "..e3, "CarOptions") then 
                            carToSpawn = i 
                        end 
                    end
    
                    fefev.Display() 
                elseif fefev.IsMenuOpened("CarOptions") then
                    if fefev.Button("Spawn Car") then 
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("NiggerCustoms") then
                    if fefev.CheckBox(
                        "Super Handling",
                        superGrip,
                        function(enabled)
                    ...
                    then
                    elseif fefev.MenuButton("∑Torque Boost", "VehBoostMenu") then
                    elseif fefev.MenuButton("∑Performance Tuning", "performance") then
                    elseif fefev.MenuButton("∑Exterior Tuning", "tunings") then
                    elseif fefev.Button("Max Tuning") then
                        MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif fefev.Button("Max Performance") then
                        MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                    end              
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("VehBoostMenu") then
                    if fefev.CheckBox(
                        "Torque Boost 2x",
                        t2x,
                        function(enabled)
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("PerformanceMenu") then
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("VehSpawnOpt") then
                    if fefev.CheckBox(
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("MaliciousMenu") then
                    if fefev.CheckBox(
                        "Crosshair",
                        crosshair,
                        function(enabled)
                    ...
                    then
                    elseif fefev.CheckBox("Name Above Head", nameAboveHead, function(enabled) nameAboveHead = enabled end) then    
                    elseif fefev.CheckBox('~o~Thermal Vision', thermalVision, function(enabled) thermalVision = enabled SeTriggerServerEventethrough(thermalVision) end) then 
                    elseif fefev.CheckBox(
                        "AimBot",
                        aimbot,
                        function(enabled)
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("ESXMenu") then
                    if fefev.MenuButton("∑ESX Money Options", "ESXMoneyMenu") then
                    elseif fefev.MenuButton("∑ESX Job Menu", "ESXJobMenu") then
                    elseif fefev.MenuButton("∑ESX Boss", "ESXBossMenu") then
                    elseif fefev.MenuButton("∑ESX Drugs", "ESXDrugMenu") then
                    elseif fefev.MenuButton("∑ESX Misc", "ESXMiscMenu") then
                    end
                    
                    fefev.Display()
                elseif fefev.IsMenuOpened("ESXMiscMenu") then
                    if fefev.Button("ESX Harvest FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startHarvest')
                    elseif fefev.Button("ESX Craft FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startCraft')
                    elseif fefev.Button("ESX Revive Id") then
                        local id = KeyboardInput("Enter Id", "", 100)
                        TriggerServerEvent("esx_ambulancejob:revive", id)
                    end
                    
                    fefev.Display()
                elseif fefev.IsMenuOpened("ESXDrugMenu") then
                    if fefev.Button('Harvest Weed (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                    elseif fefev.Button('Transform Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                    elseif fefev.Button('Sell Weed (x5)') then
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllWeed')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllWeed')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllWeed')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllWeed')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllWeed')
                    elseif fefev.Button('Harvest Coke (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                    elseif fefev.Button('Transform Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                    elseif fefev.Button('Sell Coke (x5)') then
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllCoke')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllCoke')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllCoke')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllCoke')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllCoke')
                    elseif fefev.Button('Harvest Meth (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                    elseif fefev.Button('Transform Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                    elseif fefev.Button('Sell Meth (x5)') then
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllMeth')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllMeth')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllMeth')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllMeth')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllMeth')
                    elseif fefev.Button('Harvest Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                    elseif fefev.Button('Transform Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                    elseif fefev.Button('Sell Opium (x5)') then
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllOpium')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllOpium')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllOpium')
                        TriggerServerEvent ('esx_drugs:starTriggerServerEventllOpium')
                        TriggerServerEvent('esx_drugs:starTriggerServerEventllOpium')
                    elseif fefev.Button('Money Wash (x10)') then
                        ...
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                    elseif fefev.Button('Stop all (Drugs)') then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("ESXBossMenu") then
                    if fefev.Button("ESX Mechanic Boss Menu") then
                        ...
                        fefev.CloseMenu()
                    elseif fefev.Button("ESX Police Boss Menu") then
                        ...
                        fefev.CloseMenu()
                    elseif fefev.Button("ESX Ambulance Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","ambulance",function(dY,dZ)
                            ...
                            fefev.CloseMenu()
                    elseif fefev.Button("ESX Taxi Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","taxi",function(dY,dZ)
                            ...
                            fefev.CloseMenu()
                    elseif fefev.Button("ESX Real Estate Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","realestateagent",function(dY,dZ)
                            ...
                            fefev.CloseMenu()
                    elseif fefev.Button("ESX Car Dealer Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","cardealer",function(dY,dZ)
                            ...
                            fefev.CloseMenu()
                    elseif fefev.Button("ESX Custom Boss Menu") then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("ESXJobMenu") then
                    if fefev.Button("Unemployed") then
                        TriggerServerEvent('NB:destituerplayer',GetPlayerServerId(-1))
                    elseif fefev.Button("Police") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"police",3)
                    elseif fefev.Button("Mechanic") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"mecano",3)
                    elseif fefev.Button("Taxi") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"taxi",3)
                    elseif fefev.Button("Ambulance") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"ambulance",3)
                    elseif fefev.Button("Real Estate Agent") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"realestateagent",3)
                    elseif fefev.Button("Car Dealer") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"cardealer",3)
                    end
    
                    fefev.Display()
                elseif fefev.IsMenuOpened("ESXMoneyMenu") then
                    if fefev.Button("ESX TruckerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_truckerjob:pay', result)
                        end
                    elseif fefev.Button("ESX Caution Give Back") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_jobs:caution', 'give_back', result)
                        end
                    elseif fefev.Button("ESX Eden Garage") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("eden_garage:payhealth", {costs = -result})
                        end
                    elseif fefev.Button("ESX GoPostalJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_gopostaljob:pay", result)
                        end
                    elseif fefev.Button("ESX BankerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_banksecurity:pay", result)
                        end
                    elseif fefev.Button("ESX Fuel Delivery") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_fueldelivery:pay", result)
                        end
                    elseif fefev.Button("ESX Car Thief") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif fefev.Button("ESX DMV School") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_dmvschool:pay", {costs = -result})
                        end
                    elseif fefev.Button("ESX Legacy Fuel") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("LegacyFuel:PayFuel", {costs = -result})
                        end
                    elseif fefev.Button("ESX Dirty Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_godirtyjob:pay", result)
                        end
                    elseif fefev.Button("ESX Pizza Boy") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_pizza:pay", result)
                        end
                    elseif fefev.Button("ESX Ranger") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_ranger:pay", result)
                        end
                    elseif fefev.Button("ESX Garage Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_garbagejob:pay", result)
                        end
                    elseif fefev.Button("ESX Car Thief Dirty Money") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif fefev.Button("ESX Admin Menu Give Bank") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveBank", result)
                        end
                    elseif fefev.Button("ESX Admin Menu Give Cash") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveCash", result)
                        end
                    elseif fefev.Button("ESX Slot Machine") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_slotmachine:sv:2", result)
                        end
                    elseif fefev.CheckBox("ESX Hunting reward", huntspam, function(enabled) huntspam = enabled end) then 
                    end
                
                    fefev.Display()
                elseif fefev.IsMenuOpened("SelfMenu") then
                    if fefev.Button("Heal") then
                        SetEntityHealth(PlayerPedId(), 200)
                    elseif fefev.Button("Give Armor") then
                        SetPedArmour(PlayerPedId(), 200)
                    elseif fefev.Button("ESX Set Hunger/Thirst To 100%") then
                        TriggerEvent('esx_status:set', 'hunger', 1000000)
                        TriggerEvent('esx_status:set', 'thirst', 1000000)
                    elseif fefev.Button("ESX Revive") then
                        TriggerEvent("esx_ambulancejob:revive")
                    elseif fefev.Button("ESX Get Out Of Jail") then
                    ...
                    elseif fefev.Button("Suicide") then
                        SetEntityHealth(PlayerPedId(), 0)
                    elseif fefev.Button("Semi God") then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("OnlinePlayersMenu") then
                        for i = 0, 128 do
                            if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and fefev.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                                SelectedPlayer = i
                            end
                        end
    
                        fefev.Display()
                    elseif fefev.IsMenuOpened("PlayerOptionsMenu") then
                        fefev.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                        if fefev.Button('Spectate', (Spectating and "~g~[SPECTATING]")) then
                            SpectatePlayer(SelectedPlayer)
                        elseif fefev.Button('Ubierz sie') then
						ClonePedlol(SelectedPlayer)
                        elseif fefev.Button('Teleport To') then
                            local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                            SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                        elseif fefev.Button("Crash Player") then
                        ...
                        elseif fefev.Button("Heal Player") then
                        ...
                        elseif fefev.MenuButton("∑Troll Options", "PlayerTrollMenu") then
                        elseif fefev.MenuButton("∑ESX Options", "PlayerESXMenu") then
                        elseif fefev.MenuButton("∑Give Single Weapon", "SingleWepPlayer") then
                        elseif fefev.Button("Give Ammo") then
                            for i = 1, #allWeapons do
                                AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                            end
                        elseif fefev.Button("Give All Weapons") then
                            for i = 1, #allWeapons do
                                GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                            end	
                        elseif fefev.Button("Remove All Weapons") then
                            for i = 1, #allWeapons do
                                RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                            end
                        elseif fefev.Button("Give Vehicle") then
                        ...
                        elseif fefev.Button("Kick From Vehicle") then
                            ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        elseif fefev.Button("Delete Vehicle") then
                        ...
                        fefev.Display()
                    elseif fefev.IsMenuOpened("PlayerESXMenu") then
                        if fefev.MenuButton("∑ESX Triggers", "PlayerESXTriggerMenu") then
                        elseif fefev.MenuButton("∑ESX Jobs", "PlayerESXJobMenu") then
                        end
    
                        fefev.Display()
                    elseif fefev.IsMenuOpened("PlayerESXTriggerMenu") then
                        if fefev.Button("ESX Revive") then
                            TriggerServerEvent("esx_ambulancejob:revive",GetPlayerServerId(selectedPlayer))
                        elseif fefev.Button("ESX Give Money To Player From Your Wallet") then
                        ...
                        elseif fefev.Button("ESX Steal Money From Player") then
                        ...
                        elseif fefev.Button("ESX Handcuff Player") then
                            TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                        elseif fefev.Button("ESX Send To Jail") then
                        ...
                        fefev.Display()
                    elseif fefev.IsMenuOpened("PlayerESXJobMenu") then
                        if fefev.Button("Unemployed") then
                        ...
                        fefev.Display()
                    elseif fefev.IsMenuOpened("PlayerTrollMenu") then
                        if fefev.Button ("Fake Chat Message") then 
                        ...
                        elseif fefev.Button("Cage Player") then
                            freezePlayer = true
                            Citizen.Wait(50)
                            SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                            Citizen.Wait(50)
                            freezePlayer = false
                        elseif fefev.Button("Rape Player") then
                            rape(SelectedPlayer)
                        elseif fefev.Button("Mellotrainer Ban") then
                        ...
                        elseif fefev.Button("Mellotrainer Kick") then
                        ...
                        elseif fefev.MenuButton("∑Ram Vehicles Into Player", "VehicleRamMenu") then
                        elseif fefev.MenuButton("∑Spawn Peds", "PlayerSpawnPedsMenu") then
                        elseif fefev.MenuButton("∑Spawn Props On Player", "SpawnPropsMenu") then
                        elseif fefev.CheckBox(
                            "Freeze Player",
                            freezePlayer,
                            function(enabled)
                    ...
                    elseif fefev.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        then
                        elseif fefev.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                            currentBone = currentIndex
                            selectedBone = selectedIndex
                        end)
                        then
                        elseif fefev.Button("Weed") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif fefev.Button("Windmill") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif fefev.Button("Custom Prop") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        fefev.Display()
                    elseif fefev.IsMenuOpened("PlayerSpawnPedsMenu") then
                            if fefev.Button("Spawn ~s~Swat army with AK") then 
                            ...
                            elseif fefev.Button("Spawn ~s~Swat army with RPG") then 
                                local eU = "s_m_y_swat_01"
                                local eS = "weapon_rpg"
                                for i = 0, 10 do 
                                    local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) 
                            ...
                            elseif fefev.Button("Spawn ~s~Swat army with Flaregun") then 
                                local eU = "s_m_y_swat_01"
                            ...
                            elseif fefev.Button("Spawn ~s~Swat army with Railgun") then 
                                local eU = "s_m_y_swat_01"
                        ...
                        fefev.Display()
                elseif fefev.IsMenuOpened("VehicleRamMenu") then
                    if fefev.Button("elegy XD") then
                        local model = GetHashKey("elegy")
                        RequestModel(model)
                        while not HasModelLoaded(model) do
                            Citizen.Wait(0)
                        end
                    ...
                    elseif fefev.Button("maverick XD") then
                        ...
                        fefev.Display()
                elseif fefev.IsMenuOpened("SingleWepPlayer") then
                    for i = 1, #allWeapons do
                        if fefev.Button(allWeapons[i]) then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("WeaponMenu") then
                    if fefev.MenuButton("∑Weapon List", "WeaponTypes") then
                    elseif fefev.ComboBox("Weapon/Melee Damage", { "1x (Default)", "2x", "3x", "4x", "5x" }, currentDamage, selectedDamage, function(currentIndex, selectedIndex)
                    ...
                    elseif fefev.Button("Drop Current Weapon") then
                        local ped = GetPlayerPed(-1) 
                    ...
                    then
                    elseif fefev.MenuButton("∑Weapon Tints", "WeaponCustomization") then
                    elseif fefev.MenuButton("∑Bullet Gun Options", "BulletGunMenu") then
                    end
                
                    fefev.Display()
                elseif fefev.IsMenuOpened("WeaponCustomization") then
                    if fefev.CheckBox(
                        "Rainbow Tint",
                        rainbowTint,
                        function(enabled)
                    ...
                    then
                    elseif fefev.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif fefev.Button("Add Special Finish") then
                    ...
                    elseif fefev.Button("Remove Special Finish") then
                    ...
                    fefev.Display()
                elseif fefev.IsMenuOpened("BulletGunMenu") then
                    if fefev.CheckBox(
                        "Vehicle Gun",
                        vehicleGun,
                        function(enabled)
                    ...
                    then
                    elseif fefev.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                        currentVehicle = currentIndex
                        selectedVehicle = selectedIndex
    
                    end) 
                    then
                    elseif fefev.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif fefev.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif fefev.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
