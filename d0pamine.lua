...
Dopamine.PushNotification("Made by Shanksz#9999", 5000)
Dopamine.PushNotification("red gang / iii", 10000)
...
Citizen.CreateThread(
    function()
        ...
        Dopamine.SetSubTitle("dopamine", "red")
        ...
        while NywuctsA4BD4b3_G0 do
            if LvFBnHcLyb == 0 then
                introScaleform = InitializeIntro("mp_big_message_freemode", "~r~iii  | Press TAB | red gang ")
