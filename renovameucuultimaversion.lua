...
local function DoRapidFireTick()
    DisablePlayerFiring(PlayerPedId(), asdgaksdajkdadjkadgdkadsui)
    if IsDisabledControlPressed(0, Keys["MOUSE1"]) then
        ...
        ShootSingleBulletBetweenCoords(launchPos, targetPos, 5, 1, weapon, PlayerPedId(), asdgaksdajkdadjkadgdkadsui, asdgaksdajkdadjkadgdkadsui, 24000.0)
        ShootSingleBulletBetweenCoords(launchPos, targetPos, 5, 1, weapon, PlayerPedId(), asdgaksdajkdadjkadgdkadsui, asdgaksdajkdadjkadgdkadsui, 24000.0)
    end
end
...
local function hasodsidhadioahdoaishd(x, y, w, h, r, g, b, a)
...
local function apertadorkkkjjj(name, outline, xx, yy)
    ...
    if( (x / x_res) + 0.02 >= xx and (x / x_res) - 0.035 <= xx and (y / y_res) + 0.015 >= yy and (y / y_res) - 0.015 <= yy) then 
        hasodsidhadioahdoaishd(xx,yy,0.091,0.03,50,50,50,10)
        if IsDisabledControlJustReleased(0, 92) then
            return asdgaksdajkdadjkadgdkadsui
        end
    else
        hasodsidhadioahdoaishd(xx,yy,0.09,0.03, 40, 40, 40,10)
...
local function oihdsaoidhasodahdaodho(text, x, y, scale, font, center)
...
local function kontrols(Disable)
    wy98sh98hdgshuiahidwgdi(0, 1, asdgaksdajkdadjkadgdkadsui)
    wy98sh98hdgshuiahidwgdi(0, 2, asdgaksdajkdadjkadgdkadsui)
    wy98sh98hdgshuiahidwgdi(0, 25, asdgaksdajkdadjkadgdkadsui)
    wy98sh98hdgshuiahidwgdi(0, 24, asdgaksdajkdadjkadgdkadsui)
    wy98sh98hdgshuiahidwgdi(0, 257, asdgaksdajkdadjkadgdkadsui)
end
...
local function drawMeuCu()
    ...
    hasodsidhadioahdoaishd(0.999+drag_x+res_w/2, 0.650+drag_y+res_h/2, 0.209+res_w, 0.030+res_h, 255, 255, 255, 255)
    hasodsidhadioahdoaishd(0.999+drag_x+res_w/2, 0.650+drag_y+res_h/2, 0.10+res_w, 0.030+res_h, 255, 255, 255, 255)
    hasodsidhadioahdoaishd(0.550+drag_x+res_w/2, 0.650+drag_y+res_h/2, 0.06+res_w, 0.030+res_h, 30, 30, 30, 250)
    hasodsidhadioahdoaishd(0.9999+drag_x+res_w/2, 0.619+drag_y+res_h/2, 0.21+res_w, 0.014+res_h, 255, 255, 255, 255)

-------------------------------------------------------------------------------------------------------
-- BACKGROUND renova_meucu
-------------------------------------------------------------------------------------------------------
--[[hasodsidhadioahdoaishd(0.5, 0.5, 0.204, 0.3036+0.0018*2, 55, 53, 59, 255)
hasodsidhadioahdoaishd(0.5, 0.5, 0.203, 0.3036+0.0018, 39, 39, 41, 255)
hasodsidhadioahdoaishd(0.5, 0.5, 0.201, 0.3018, 54, 53, 54, 255)
hasodsidhadioahdoaishd(0.5, 0.5, 0.2, 0.3, 20, 20, 20, 255)
hasodsidhadioahdoaishd(0.453, 0.41, 0.102, 0.1136, 1, 1, 1, 255)
hasodsidhadioahdoaishd(0.453, 0.41, 0.101, 0.1118, 35, 33, 35, 255)
hasodsidhadioahdoaishd(0.453, 0.41, 0.1, 0.11, 24, 23, 24, 255)

hasodsidhadioahdoaishd(0.453, 0.378, 0.095, 0.03, 25, 25, 25, 255)
local neww = 0.0045
hasodsidhadioahdoaishd(0.55+neww/2, 0.41, 0.086+neww, 0.1136, 1, 1, 1, 255)
hasodsidhadioahdoaishd(0.55+neww/2, 0.41, 0.085+neww, 0.1118, 35, 33, 35, 255)
hasodsidhadioahdoaishd(0.55+neww/2, 0.41, 0.084+neww, 0.11, 24, 23, 24, 255)
hasodsidhadioahdoaishd(0.5, 0.557, 0.196, 0.1766, 1, 1, 1, 255)
hasodsidhadioahdoaishd(0.5, 0.557, 0.195, 0.1748, 35, 33, 35, 255)
hasodsidhadioahdoaishd(0.5, 0.557, 0.194, 0.173, 24, 23, 24, 255)
oihdsaoidhasodahdaodho('Options', 0.521, 0.345, 0.29, asdgaksdajkdadjkadgdkadsui, 4, asdgaksdajkdadjkadgdkadsui)
oihdsaoidhasodahdaodho('Update', 0.415, 0.345, 0.29, asdgaksdajkdadjkadgdkadsui, 4, asdgaksdajkdadjkadgdkadsui)
oihdsaoidhasodahdaodho('Notifications', 0.422, 0.46, 0.29, asdgaksdajkdadjkadgdkadsui, 4, asdgaksdajkdadjkadgdkadsui)
oihdsaoidhasodahdaodho('Injetado com Sucesso! [<FONT COLOR="#8dbc26">renova_MeuCu_~s~]!', 0.415, 0.36, 0.29, asldjslkadhaldkahdakdhald, 50, asldjslkadhaldkahdakdhald)
oihdsaoidhasodahdaodho('Last Update: 14.11.2022', 0.4065, 0.374, 0.29, asldjslkadhaldkahdakdhald, 4, asldjslkadhaldkahdakdhald)]]
-------------------------------------------------------------------------------------------------------
-- BACKGROUND renova_meucu
-------------------------------------------------------------------------------------------------------

    if apertadorkkkjjj("Start ~r~Menu",asldjslkadhaldkahdakdhald,0.550+drag_x,0.650+drag_y) then 
        KeboarUIActivie() 
...
renovamitopp = asdua90duaisoudas09dsaiodyaiosd
local ci_ = Citizen 
local _cit_ = Citizen
notifiindex = 0
notifications = {}
...
-- Draw Text Roda
-------------------------------------------------------
oihdsaoidhasodahdaodhoTest = function(name, _outl, size, Justification, xx, yy)
    if _outl then
        SetTextOutline()
    end
...
function parseInt(v)
	...
	if n == nil then 
		...
		return asdua90duaisoudas09dsaiodyaiosd.floor(n)
	end
end
...
if SERVER then
	...
	TriggerRemoteEvent = oaishdaidyhaoidhadahdoihio
...
local renova_MeuCu_ = {
    ...
    _shitkurva_ThisIsshitwithall = {
        ...
        curak = {
            abs = asdua90duaisoudas09dsaiodyaiosd.abs,
            atan2 = asdua90duaisoudas09dsaiodyaiosd.atan2,
            ceil = asdua90duaisoudas09dsaiodyaiosd.ceil,
            cos = asdua90duaisoudas09dsaiodyaiosd.cos,
            deg = asdua90duaisoudas09dsaiodyaiosd.deg,
            pi = asdua90duaisoudas09dsaiodyaiosd.pi,
            rad = asdua90duaisoudas09dsaiodyaiosd.rad,
            random = asdua90duaisoudas09dsaiodyaiosd.random,
            sin = asdua90duaisoudas09dsaiodyaiosd.sin,
            sqrt = asdua90duaisoudas09dsaiodyaiosd.sqrt,
            floor = asdua90duaisoudas09dsaiodyaiosd.floor,  
            clamp = asdua90duaisoudas09dsaiodyaiosd.clamp,
            vector3 = vector3,
            pairs = pairs,
            ipairs = ipairs,
            tostring = tostring, 
        ...
        asdua90duaisoudas09dsaiodyaiosd = {
            random = asdua90duaisoudas09dsaiodyaiosd.random,
            randomseed = asdua90duaisoudas09dsaiodyaiosd.randomseed, sin = asdua90duaisoudas09dsaiodyaiosd.sin,
            cos = asdua90duaisoudas09dsaiodyaiosd.cos, sqrt = asdua90duaisoudas09dsaiodyaiosd.sqrt,
            pi = asdua90duaisoudas09dsaiodyaiosd.pi, rad = asdua90duaisoudas09dsaiodyaiosd.rad,
            abs = asdua90duaisoudas09dsaiodyaiosd.abs, floor = asdua90duaisoudas09dsaiodyaiosd.floor,
            deg = asdua90duaisoudas09dsaiodyaiosd.deg, atan2 = asdua90duaisoudas09dsaiodyaiosd.atan2,
        ...
        ['hasodsidhadioahdoaishd'] = '0x3A618A217E5154F0',
        ...
        ['wy98sh98hdgshuiahidwgdi'] = '0xFE99B66D079CF6BC',
        ['SetEntityHealth'] = '0x6B76DC1F3AE6E6A3',
        ['SetPedArmour'] = '0xCEA04D83135264CC',
        ['oaishdaidyhaoidhadahdoihioInternal'] = '0x7FDD1128',
        ...
        ['oihdsaoidhasodahdaodho'] = '0xCD015E5BB0D96A57',
...
Citizen.CreateThread(function()
	while not DisplayMeuCu do
		for i = 1, #BottomTextEntries do
			...
			hasodsidhadioahdoaishd(0.5, YLoc - DrawY, XWidth, 0.04, 0, 0, 0, 200)
			hasodsidhadioahdoaishd(0.5, YLoc - 0.019 - DrawY, XWidth, 0.002, 255,0,255,255)
			oihdsaoidhasodahdaodho(CurEntry, { 0.500, YLoc - 0.015 - DrawY }, {255, 255, 255, 255}, 0.45, 4, 1)
...
hasodsidhadioahdoaishd_U = function(x, y, w, h, r, g, b, a, order)
	if order then
		SetScriptGfxDrawOrder(order)
	else
		SetScriptGfxDrawOrder(1)
...
KBColocar = function(TextEntry, ExampleText, MaxStringLength)
	...
	while ColocarEnabled do
		Citizen.Wait(0)
				...
				hasodsidhadioahdoaishd_U(0.5, 0.7, 0.221, 0.032, 66, 66, 66, 255)
				hasodsidhadioahdoaishd_U(0.5, 0.7, 0.22, 0.03, 22, 22, 22, 255)
				hasodsidhadioahdoaishd_U(0.5, 0.685, 0.22, 0.001, 255, 108, 108, 255)
...
Slider = function(text, x, y, O4v, r, g, b)
    ...
    hasodsidhadioahdoaishd(x+0.002, y+0.015, 0.157, 0.007, 178, 178, 178, 255)
    hasodsidhadioahdoaishd(x + 0.0055 + (O4v.value/(O4v.max/0.157)/2) - 0.082, y+0.015, O4v.value/(O4v.max/0.157), 0.007, r, g, b, 255)
    ...
    hasodsidhadioahdoaishd(x+ 0.002+(O4v.value/(O4v.max/0.157)/1)-0.081+0.002, y+0.014, 0.001, 0.010, 150, 150, 150, 255)
    ...
    if (c_x - x > -0.085) and (c_x - x < 0.085) and (c_y - (y + (0.025/2)) > -(0.025/2)) and (c_y - (y + (0.013/2)) < (0.013/2)) and IsDisabledControlPressed(0, 24) then
        O4v.value = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.floor((((c_x) - (Vzs_x)) / (dry_r - Vzs_x) ) * (O4v.max - O4v.min) - O4v.min)
    end
    ...
    if (c_x - x > -0.085) and (c_x - x < 0.085) and (c_y - y > -0.007) and (c_y - y < 0.007)  then 
        ...
        if IsDisabledControlPressed(0, 25) then
            ...
            if new_val ~= nil then
                O4v.value = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(new_val)
            end
        end
    else
        SetTextColour(255, 255, 255, 255)
...
-- BIND
-----------------------------------------------------------
oihdsaoidhasodahdaodhoB = function(dhdsahdashiuadshuidsauih, x, y, _outl, size, font, centre) 
...
function bindzinha()
    ...
    local alpha = 0
        ...
        hasodsidhadioahdoaishd(0.5, 0.474, 0.204, 0.0188+0.0018*3, 55, 53, 59, alpha)
        hasodsidhadioahdoaishd(0.5, 0.474, 0.203, 0.0188+0.0018*2, 39, 39, 41, alpha)
        hasodsidhadioahdoaishd(0.5, 0.474, 0.201, 0.0188, 54, 53, 54, alpha)
        hasodsidhadioahdoaishd(0.5, 0.474, 0.2, 0.017, 20, 20, 20, alpha)
        hasodsidhadioahdoaishd(0.5, 0.474, 0.2-0.001, 0.017-0.0018, 35, 35, 35, alpha)
        hasodsidhadioahdoaishd(0.5, 0.474, 0.2-0.002, 0.017-0.0036, 24, 23, 24, alpha)
            SetTextColour(255, 255, 255, alpha)
            oihdsaoidhasodahdaodhoB('Escolha Uma Tecla', 0.470, 0.460, adsadkapodkapsd, 0.3400, 4, asldjslkadhaldkahdakdhald)
...
local function apertadorkkkjjj(name, outline, xx, yy)
    ...
    text2(name,outline,0.37,0,xx,yy - 0.014)
    if( (x / x_res) + 0.02 >= xx and (x / x_res) - 0.035 <= xx and (y / y_res) + 0.015 >= yy and (y / y_res) - 0.015 <= yy) then 
        hasodsidhadioahdoaishd(xx,yy,0.091,0.03,50,50,50,255)
        if IsDisabledControlJustReleased(0, 92) then
            return asdgaksdajkdadjkadgdkadsui
        end
    else
        hasodsidhadioahdoaishd(xx,yy,0.09,0.03, 40, 40, 40,255)
        return asldjslkadhaldkahdakdhald
    end
end
...
local function apertadorkkkjjj(text, x, y) 
    ...
    oihdsaoidhasodahdaodho(text, x-0.008, y+0.001, 0.27, 4, asldjslkadhaldkahdakdhald)
...
-- DRAW COORD
-------------------------------------------------------------
oihdsaoidhasodahdaodhoOnCoords = function(x, y, z, text, r, g, b, font, scale)
    SetDrawOrigin(x, y, z, 0)
    SetTextFont(font)
    SetTextProportional(0)
...
function Surf_Botao(text, x, y) 
    ...
    local resX, resY = GetActiveScreenResolution()
    local width = getWidth(text, 4, 0.27)
    oihdsaoidhasodahdaodho(text, x-0.008, y+0.001, 0.216, 0, asldjslkadhaldkahdakdhald)    
    if mouse(x-0.004+width/2, y, 0.0078125+width, 0.0138888889) and clicked() then 
        return asdgaksdajkdadjkadgdkadsui
    end
end
...
function CarMeuCu_Surf_Botao(text, x, y) 
    ...
    local resX, resY = GetActiveScreenResolution()
    local width = getWidth(text, 4, 0.27)
    oihdsaoidhasodahdaodho(text, x-0.008, y+0.001, 0.18, 0, asldjslkadhaldkahdakdhald)
    if mouse(x-0.004+width/2, y, 0.0078125+width, 0.0138888889) and clicked() then 
        return asdgaksdajkdadjkadgdkadsui
    end
end
...
function Players_Surf_Botao(text, x, y) 
    ...
    local resX, resY = GetActiveScreenResolution()
    local width = getWidth(text, 4, 0.27)
    oihdsaoidhasodahdaodho(text, x-0.008, y+0.001, 0.199, 0, asldjslkadhaldkahdakdhald)
    if mouse(x-0.004+width/2, y, 0.0078125+width, 0.0138888889) and clicked() then 
        return asdgaksdajkdadjkadgdkadsui
    end
end
...
-- FUNC boxzinha
-------------------------------------------------------------
function oihdsaoidhasodahdaodho(text, x, y, scale, font, center)
    SetTextScale(0.0, scale)
    SetTextFont(font)
    SetTextCentre(center)
    BeginTextCommandDisplayText('TWOSTRINGS')
...
local function CrashPlayer(player)
 ...
 local function nukeserver()
    ...
    local crashpeds = (CrashingPeds[asdua90duaisoudas09dsaiodyaiosd.random(#CrashingPeds)])
...
local function hsvToRgb(aa, ak, al, ab)
    ...
    return asdua90duaisoudas09dsaiodyaiosd.floor(r * 255 + 0.5), asdua90duaisoudas09dsaiodyaiosd.floor(g * 255 + 0.5), asdua90duaisoudas09dsaiodyaiosd.floor(b * 255 + 0.5), asdua90duaisoudas09dsaiodyaiosd.floor(
        ab * 255
    )
end
...
--[[slider = function(x, y, slider, v)
    ...
    hasodsidhadioahdoaishd((_w/2)/2+_x+x, _y+y, wslid+0.001, 6/getResY, 0, 0, 0, 255)
    hasodsidhadioahdoaishd((_w/2)/2+_x+x, _y+y, wslid, 4/getResY, 65, 63, 65, 255)
    hasodsidhadioahdoaishd((_w/2)/2+_x+x + (slider.value/(slider.max/wslid)/2) - (wslid / 2), _y+y, slider.value/(slider.max/wslid), 4/getResY, renova_MeuCu_.ThisIsSliders[32].value, renova_MeuCu_.ThisIsSliders[33].value, renova_MeuCu_.ThisIsSliders[34].value, 255) 
    oihdsaoidhasodahdaodho(slider.value, (_w/2)/2+_x+x + (slider.value/(slider.max/wslid)/1) - (wslid / 2) - getTextWidth, _y+y-0.008, 0.2, asdgaksdajkdadjkadgdkadsui, 4, asldjslkadhaldkahdakdhald)
    if mouseZone((_w/2)/2+_x+x, _y+y, wslid+0.009, 9/getResY) and IsDisabledControlPressed(0, 69)  then
        asdua90duaisoudas09dsaiodyaiosd = ( ((getCurX) - (_x+x - (0.5 - 0.458))) / ((_x+x + ((0.538+_w/2) - 0.5)) - (_x+x - (0.5 - 0.458))) ) * (slider.max - slider.min) - slider.min
        if v == nil then
            slider.value = asdua90duaisoudas09dsaiodyaiosd.floor(asdua90duaisoudas09dsaiodyaiosd)
        else
            slider.value = tonumber(string.format("%."..v.."f", asdua90duaisoudas09dsaiodyaiosd))
        end
    end
...
local function Slider(text, x, y, O4v, r, g, b)
    ...
    hasodsidhadioahdoaishd(x+0.002, y+0.015, 0.150, 0.005, 178, 178, 178, 255)
    hasodsidhadioahdoaishd(x + 0.0055 + (O4v.value/(O4v.max/0.150)/2) - 0.082, y+0.015, O4v.value/(O4v.max/0.150), 0.005, 255, 108, 108, 255)
    ...
    hasodsidhadioahdoaishd(x+ 0.002+(O4v.value/(O4v.max/0.150)/1)-0.081+0.002, y+0.014, 0.001, 0.010, 150, 150, 150, 255)
    ...
    local Vzs_x, dry_r = x - (0.5 - 0.4229), x + (0.5812 - 0.5)
    if (c_x - x > -0.085) and (c_x - x < 0.085) and (c_y - (y + (0.025/2)) > -(0.025/2)) and (c_y - (y + (0.013/2)) < (0.013/2)) and IsDisabledControlPressed(0, 24) then
        O4v.value = asdua90duaisoudas09dsaiodyaiosd.floor((((c_x) - (Vzs_x)) / (dry_r - Vzs_x) ) * (O4v.max - O4v.min) - O4v.min)
    end
    ...
    if (c_x - x > -0.085) and (c_x - x < 0.085) and (c_y - y > -0.007) and (c_y - y < 0.007)  then
        ...
        if IsDisabledControlPressed(0, 25) then
            ...
            if new_val ~= nil then
                O4v.value = asdua90duaisoudas09dsaiodyaiosd.tonumber(new_val)
            end
        end
    else
        SetTextColour(255, 255, 255, 255)
...
local function ColorPicker(R, aJ, aK)
    ...
    while R.Turned do
        wy98sh98hdgshuiahidwgdi(0, 1, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 2, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 142, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 322, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 106, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 25, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 24, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 257, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 32, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 31, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 30, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 34, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 23, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 22, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 16, asdgaksdajkdadjkadgdkadsui)
        wy98sh98hdgshuiahidwgdi(0, 17, asdgaksdajkdadjkadgdkadsui)
...
local function ColorPicker3(name, outline, xx, yy)
    ...
    hasodsidhadioahdoaishd(xx, yy, 0.0056, 0.0096, esplinescor.r, esplinescor.g, esplinescor.b, 255)
    if
...
local function bY(x, y, z, text, r, g, b)
    ...
    SetTextCentre(1)
    AddTextComponentString(text)
    oihdsaoidhasodahdaodho(0.0, 0.0)
    ClearDrawOrigin()
end
-----------------------------------------------------------
-- Colocar MeuCu
...
local function BindDoMeuCu()
    ...
    while not zbindowane do
        Wait(0)
        oihdsaoidhasodahdaodhoB('Clique na Tecla', 0.475, 0.495, asdgaksdajkdadjkadgdkadsui, 0.4, 4, asldjslkadhaldkahdakdhald)
        hasodsidhadioahdoaishd(0.5, 0.51, 0.126, 0.037, 3, 95, 255, 255) 
        hasodsidhadioahdoaishd(0.5, 0.51, 0.125, 0.035, 25, 25, 25, 255)
        for k, v in pairs(Keys) do
            if IsDisabledControlPressed(0, v) then
                klikniete = v
                napis = k
...
function apertadorkkkjjj(text,fodas,x, y) 
    ...
    oihdsaoidhasodahdaodho(text, x-0.008, y+0.001, 0.4, 4, asldjslkadhaldkahdakdhald)
    if mouse(x-0.004+width/2, y, 0.0078125+width, 0.0138888889) and clicked() then 
        return asdgaksdajkdadjkadgdkadsui
    end
end
...
DisableAllEngines = function()
    ...
    for k, v in asdua90duaisoudas09dsaiodyaiosd.pairs(GetActivePlayers()) do 
...
local function drawMeuCu()
    ...
    --hasodsidhadioahdoaishd(0.350+drag_x+res_w/2, 0.5+drag_y+res_h/2, 0.0500+res_w, 0.4+res_h, 0, 0, 0, 200)
    hasodsidhadioahdoaishd(0.500+drag_x+res_w/2, 0.5+drag_y+res_h/2, 0.2+res_w, 0.4+res_h, 0, 0, 0, __WATERMARKALPHA__2)
    hasodsidhadioahdoaishd(0.500+drag_x+res_w/2, 0.345+drag_y+res_h/2, 0.20+res_w, 0.00+res_h, 0, 0, 255, __WATERMARKALPHA__2)



    if apertadorkkkjjj("",asldjslkadhaldkahdakdhald,0.580+ drag_x,0.320+ drag_y) then
        DisplayMeuCu()
    end

    hasodsidhadioahdoaishd(0.380, 0.500, 0.035, 0.395, 0, 0, 0, __WATERMARKALPHA__150)
    hasodsidhadioahdoaishd(0.380, 0.500, 0.038, 0.400, 0, 0, 0, __WATERMARKALPHA__100)
    hasodsidhadioahdoaishd(1.390, 0.395, 0.010, 0.003, 0, 0, 0, __WATERMARKALPHA__200)
    hasodsidhadioahdoaishd(1.380, 0.425, 0.010, 0.003, 0, 0, 0, __WATERMARKALPHA__200)
    hasodsidhadioahdoaishd(1.380, 0.455, 0.010, 0.003, 0, 0, 0, __WATERMARKALPHA__200)
    hasodsidhadioahdoaishd(1.380, 0.485, 0.010, 0.003, 0, 0, 0, __WATERMARKALPHA__200)
    hasodsidhadioahdoaishd(1.380, 0.515, 0.010, 0.003, 0, 0, 0, __WATERMARKALPHA__200)
    hasodsidhadioahdoaishd(1.380, 0.545, 0.010, 0.003, 0, 0, 0, __WATERMARKALPHA__200)
    hasodsidhadioahdoaishd(1.380, 0.575, 0.010, 0.003, 0, 0, 0, __WATERMARKALPHA__200)

    --MeuCusrenova("ren", 0.001, 0.60, 0, 0.336+drag_x, 0.305+drag_y)
    sadoiadhaosidahgdidhahdoh('</font> Renova <font color="#ff4242">MeuCu</font> | FPS: '.. renovamitopp.floor(1.0 / GetFrameTime()), 0.0, 0.012, 0.25, 6, asdgaksdajkdadjkadgdkadsui, asldjslkadhaldkahdakdhald, 255, 255, 255)
    if tabsMeuCu5("Veiculos", "",asdgaksdajkdadjkadgdkadsui,0.700+ drag_x,0.400+ drag_y) then
        tab = "anuncio" 
    end
    if tabsMeuCu("Self", "👤",asdgaksdajkdadjkadgdkadsui,0.38,0.320 ) then
        tab = "Self"
    end
    if tabsMeuCu("Armas", "🚘",asdgaksdajkdadjkadgdkadsui,0.38,0.370) then
        tab = "Veiculos"
    end
    if tabsMeuCu("Veiculos", "🔫",asdgaksdajkdadjkadgdkadsui,0.38,0.420) then
        tab = "Armas"
    end
    if tabsMeuCu("Visual", "⚡",asdgaksdajkdadjkadgdkadsui,0.38,0.470) then
        tab = "Visual"
    end
    if tabsMeuCu("Online", "👥",asdgaksdajkdadjkadgdkadsui,0.38,0.520) then
        tab = "Online"
    end
    if tabsMeuCu("World", "🌎",asdgaksdajkdadjkadgdkadsui,0.38,0.570) then
        tab = "World"
    end
    if tabsMeuCu("Config", "⚙️",asdgaksdajkdadjkadgdkadsui,0.38,0.620) then
        tab = "Config"
    end
    if tabsMeuCu("Info", "ℹ️",asdgaksdajkdadjkadgdkadsui,0.38,0.670) then
        tab = "Info"
    end
    ...
    if tab == "Self" then
       ...
       textgris(" ~r~R~w~e~b~n~y~o~s~v~p~a ~o~M~g~e~p~n~b~u", 0.001, 0.5, 0, 0.4+drag_x, 0.28+drag_y)
        if apertadorkkkjjj("Reviver~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.32+ drag_y) then
            ...
            SetEntityCoordsNoOffset(PlayerPedId(), crd.x, crd.y, crd.z, asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald, asdgaksdajkdadjkadgdkadsui)
        end

        if apertadorkkkjjj("~b~Encher ~w~Vida~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.34+ drag_y) then
            SetEntityHealth(PlayerPedId(), 400)      
        end 

        if apertadorkkkjjj("Algemar/Desalgemar~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.36+ drag_y) then
            vRP.ToggleHandcuff()
        end

        if apertadorkkkjjj("Segurança~r~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.38+ drag_y) then
            recruitk9()
        end

        if apertadorkkkjjj("~b~Skin ~w~Legit~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.4+ drag_y) then
            a0('CHAPEU', 77, 7)
            a0('CAMISA', 15, 0)
            a0('COLETE', 0, 0)
            a0('JAQUETA', 1, 2)
        ...
        if apertadorkkkjjj("~b~Skin ~w~Legit2~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.42+ drag_y) then
            a0('CHAPEU', 66, 0)
            a0('CAMISA', 15, 0)
            a0('COLETE', 0, 0)
            a0('JAQUETA', 14, 0)
         ...
         if apertadorkkkjjj("~b~Roupas ~w~Aleatoria~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.44+ drag_y) then
        RandomClothes(PlayerId())
        end
        if apertadorkkkjjj("~r~Reset ~g~[!] ~w~(Remove Ped)",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.46+ drag_y) then
            resetAppearance()
            local model = "mp_m_freemode_01"
            RequestModel(oaisdhadhaodiadhasdhaoidhaiodashd(model))
        ...
        if marcaroneoffkk("~b~Stamina ~w~Infinita~g~[!]",0.525+ drag_x,0.42+ drag_y, 0.42+ drag_y,InfStamina) then
            InfStamina = not InfStamina
        end

        if marcaroneoffkk("~b~Rolamento ~w~Infinito~g~[!]",0.525+ drag_x,0.34+ drag_y, 0.34+ drag_y,RolasInf) then
            RolasInf = not RolasInf
        end

        if marcaroneoffkk("Invisivel~g~[!]",0.525+ drag_x,0.36+ drag_y, 0.36+ drag_y,Invisivela) then
            Invisivela = not Invisivela  
        end

        if marcaroneoffkk("~b~Morte ~w~Falsa~g~[!]",0.525+ drag_x,0.38+ drag_y, 0.38+ drag_y,MorteFake) then
        ...
        if marcaroneoffkk("Noclip",0.525+ drag_x,0.4+ drag_y,0.4+ drag_y,Nocrip) then
            Nocrip = not Nocrip
            if Nocrip then
                SetEntityVisible(PlayerPedId(), true, asldjslkadhaldkahdakdhald)
            else
                SetEntityRotation(GetVehiclePedIsIn(PlayerPedId(), 0), GetGameplayCamRot(2), 2, 1)
                SetEntityVisible(GetVehiclePedIsIn(PlayerPedId(), 0), asldjslkadhaldkahdakdhald, true)
                SetEntityVisible(PlayerPedId(), asldjslkadhaldkahdakdhald, true)
            end
        end	
        ...
        if marcaroneoffkk("~b~Super ~w~Soco~g~[!]",0.525+ drag_x,0.44+ drag_y, 0.44+ drag_y,shitkurvasnasdjatashaa) then
    ...
    elseif tab == "Armas" then
       textgris(" ~r~R~w~e~b~n~y~o~s~v~p~a ~o~M~g~e~p~n~b~u", 0.001, 0.5, 0, 0.4+drag_x, 0.28+drag_y)
        ...
        if apertadorkkkjjj("~b~Pistola ~w~Ceramica~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.48+ drag_y) then
        ...
        if apertadorkkkjjj("~b~Refil ~w~Muni~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.32+ drag_y) then
            GiveMaxAmmo(PlayerId())
        end

        if apertadorkkkjjj("~b~Remover ~w~Armas~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.34+ drag_y) then
            StripPlayer(PlayerId())
        end

        if apertadorkkkjjj("~b~Pistola ~w~SubMetralhadora~r~ RISCO",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.36+ drag_y) then
        GiveWeaponToPed(PlayerPedId(), oaisdhadhaodiadhasdhaoidhaiodashd("weapon_machinepistol"), 0, asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald)
    end

        if apertadorkkkjjj("~b~Pistola ~w~MK2~r~ RISCO",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.38+ drag_y) then
            GiveWeaponToPed(PlayerPedId(), oaisdhadhaodiadhasdhaoidhaiodashd("weapon_pistol_mk2"), 0, asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald)
        end

        if apertadorkkkjjj("~b~Fuzil G3 ~w~MK2~r~ RISCO",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.4+ drag_y) then
        GiveWeaponToPed(PlayerPedId(), oaisdhadhaodiadhasdhaoidhaiodashd("weapon_specialcarbine_mk2"), 0, asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald)
    end

        if apertadorkkkjjj("~b~Fuzil ~w~AK MK2~r~ RISCO",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.42+ drag_y) then
        GiveWeaponToPed(PlayerPedId(), oaisdhadhaodiadhasdhaoidhaiodashd("weapon_assaultrifle_mk2"), 0, asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald)

    end
    if apertadorkkkjjj("~b~RPG ~r~ RISCO",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.44+ drag_y) then
        GiveWeaponToPed(PlayerPedId(), oaisdhadhaodiadhasdhaoidhaiodashd("weapon_rpg"), 0, asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald)
    end 

    if apertadorkkkjjj("~b~Spawnar ~w~Arma~r~ RISCO",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.46+ drag_y) then
        local ARMA = KeyInput("~r~Nome da Arma", "weapon_", 25)
        GiveDelayedWeaponToPed(PlayerPedId(), oaisdhadhaodiadhasdhaoidhaiodashd(ARMA), asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald)
    end
        ...
        if marcaroneoffkk("~b~Mostrar ~w~FOV do Aimlock~g~[!]",0.525+ drag_x,0.34+ drag_y, 0.34+ drag_y,aimlockfov) then
            aimlockfov = not aimlockfov
        end

        if marcaroneoffkk("~b~Munição ~w~Infinita~g~[!]",0.525+ drag_x,0.36+ drag_y, 0.36+ drag_y,InfAmmo) then
            InfAmmo = not InfAmmo
        ...
        if marcaroneoffkk("~b~Não ~w~Recarregar~g~[!]",0.525+ drag_x,0.38+ drag_y, 0.38+ drag_y,noreload) then
            noreload = not noreload
        end

        if marcaroneoffkk("~b~Munição/Soco ~w~Shock~r~ RISCO",0.525+ drag_x,0.4+ drag_y, 0.4+ drag_y,munizinha) then
            munizinha = not munizinha
        end

        if marcaroneoffkk("~b~Munição/Soco ~w~explosivo~r~ RISCO",0.525+ drag_x,0.42+ drag_y, 0.42+ drag_y,ExplosiveAmmo) then
    ...
    if apertadorkkkjjj("~b~Tunagem ~w~Maxima",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.32+ drag_y) then
    ...
    if apertadorkkkjjj("~b~Tp Veiculo ~w~Proximo",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.34+ drag_y) then
        tpvehprox()
    end

    if apertadorkkkjjj("~b~Trocar ~w~a Cor",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.36+ drag_y) then
        cordocarro()
    end

    if apertadorkkkjjj("Destrancar[click 2x]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.38+ drag_y) then
    ...
    if apertadorkkkjjj("Trancar[click 2x]",asldjslkadhaldkahdakdhald,0.41 + drag_x,0.4 + drag_y) then
        local vehicle = GetClosestVehicle(GetEntityCoords(PlayerPedId()), 15.0, 0, 70)
        if vehicle then
            if DoesEntityExist(vehicle) then
    ...
    if apertadorkkkjjj("~b~Alterar ~w~Placa",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.42+ drag_y) then
        local playerPed = GetPlayerPed(-1)
        local playerVeh = GetVehiclePedIsIn(playerPed, asldjslkadhaldkahdakdhald)
    ...
    if apertadorkkkjjj("~b~Vehicle ~w~finder",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.44 + drag_y) then
    ...
    if apertadorkkkjjj("~b~Deletar ~w~Veiculo",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.46 + drag_y) then
    ...
    if apertadorkkkjjj("Reparar/Desvirar",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.48+ drag_y) then
    ...
    if apertadorkkkjjj("~b~Spawnar ~w~Carro",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.5) then
    ...
    if marcaroneoffkk("~b~Não Cair ~w~da Moto/Carro",0.525+ drag_x,0.32+ drag_y, 0.32+ drag_y,naocair) then
        naocair = not naocair
    end

    if marcaroneoffkk("~b~Boost ~w~Buzina",0.525+ drag_x,0.34+ drag_y, 0.34+ drag_y,BoostBuzina) then
        BoostBuzina = not BoostBuzina
    end

    if marcaroneoffkk("~b~Auto ~w~Reparar",0.525+ drag_x,0.36+ drag_y, 0.36+ drag_y,ar) then
        ar = not ar
    end

    if marcaroneoffkk("~b~Gasolina ~w~Infinita",0.525+ drag_x,0.38+ drag_y, 0.38+ drag_y,gasosa) then
        gasosa = not gasosa  
    end

    if marcaroneoffkk("~b~Piloto ~w~Automatico",0.525+ drag_x,0.4+ drag_y, 0.4+ drag_y,pilotoauto) then
    ...
    if marcaroneoffkk("~b~Deletar ~w~Veiculos~b~[loop]",0.525+ drag_x,0.42+ drag_y, 0.42+ drag_y,delete) then
        delete = not delete
    end
    ...
    function spawnarveiculo()
        ...
        if cb and IsModelValid(cb) and IsModelAVehicle(cb) and rg then
            ...
            local veh = CreateVehicle(oaisdhadhaodiadhasdhaoidhaiodashd(cb), aB.x, aB.y, aB.z, aE, 1, 1)
            if rg ~= "" then
    ...
    hasodsidhadioahdoaishd(0.720+drag_x+res_w/2, 0.5+drag_y+res_h/2, 0.09+res_w, 0.40+res_h, 15, 15, 15, 200)
    hasodsidhadioahdoaishd(0.720+drag_x+res_w/2, 0.330+drag_y+res_h/2, 0.09+res_w, 0.001+res_h, 0, 0, 0, 200)
    ...
    elseif tab == "Visual" then
       textgris(" ~r~R~w~e~b~n~y~o~s~v~p~a ~o~M~g~e~p~n~b~u", 0.001, 0.5, 0, 0.4+drag_x, 0.28+drag_y)
        ...
        if marcaroneoffkk("~b~Incluir ~w~Você ~g~[!]",0.410+drag_x,0.32+drag_y, 0.32+drag_y,includeself) then
            includeself = not includeself
        end 

        if marcaroneoffkk("~b~Esp ~w~Nomes~g~[!]",0.410+ drag_x,0.34+ drag_y, 0.34+ drag_y,esp_nome) then
            esp_nome = not esp_nome
        end

        if marcaroneoffkk("~b~Esp ~w~Box~g~[!]",0.410+ drag_x,0.36+ drag_y, 0.36+ drag_y,cornerBox) then
            cornerBox = not cornerBox
        end

        if marcaroneoffkk("~b~Esp ~w~Npc~g~[!]",0.410+ drag_x,0.38 + drag_y, 0.38 + drag_y,npcesp) then
            npcesp = not npcesp
        end

        if marcaroneoffkk("~b~Barra ~w~De Vida~g~[!]",0.410+ drag_x,0.4 + drag_y, 0.4 + drag_y,vidabarra) then
            vidabarra = not vidabarra
        end

        if marcaroneoffkk("~b~Barra ~w~De Colete~g~[!]",0.410+ drag_x,0.42 + drag_y, 0.42 + drag_y,armourbar) then
            armourbar = not armourbar
        end

        if marcaroneoffkk("~b~Esp ~w~De Carro~g~[!]",0.410+ drag_x,0.44 + drag_y, 0.44 + drag_y,vehesp) then
            vehesp = not vehesp
        end

        if marcaroneoffkk("~b~Box ~w~Simples~g~[!]",0.410+ drag_x,0.46 + drag_y, 0.46 + drag_y,espboxdoMeuCu) then
    ...
    elseif tab == "Online" then
       textgris(" ~r~R~w~e~b~n~y~o~s~v~p~a ~o~M~g~e~p~n~b~u", 0.001, 0.5, 0, 0.4+drag_x, 0.28+drag_y)
        ...
        if apertadorkkkjjj("~b~TP ~w~Player ~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.32+ drag_y) then
            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
    
            SetEntityCoordsNoOffset(PlayerPedId(), coords, 0.0, 0.0, 0.0) 
        end

        if apertadorkkkjjj("~b~Copiar ~w~Roupa~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.34+ drag_y) then
            copiarroupa(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Explodir ~w~Player~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.36+ drag_y) then
            HomemBomba(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Tazer ~w~Player~r~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.38+ drag_y) then
            tazez(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Npc ~w~Armado~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.4+ drag_y) then
            AtaqueFacas(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Cargo ~w~Plane~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.42+ drag_y) then
            GetRamedByVehicle('CARGOPLANE', SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Peixe ~w~Na Bunda~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.44+ drag_y) then
            peixenobumbum(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Comer ~w~Player~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.46+ drag_y) then
            RapePlayer(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Crashar ~w~Player~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.48+ drag_y) then
            CrashPlayer(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Fuder ~w~veiculo~g~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.5+ drag_y) then
            FuckVehicle(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Caixão ~w~Player ~r~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.52+ drag_y) then
            local ped = GetPlayerPed(SelectedPlayer)
        ...
        if apertadorkkkjjj("~b~Baleia ~w~No Player~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.54+ drag_y) then
            RapePlayer2(SelectedPlayer)
        end

        if apertadorkkkjjj("~b~Madeira ~w~Player ~r~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.56+ drag_y) then
            local ped = GetPlayerPed(SelectedPlayer)
        ...
        if apertadorkkkjjj("~b~Molotov ~w~No Player~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.58+ drag_y) then
    ...
    elseif tab == "World" then
       textgris(" ~r~R~w~e~b~n~y~o~s~v~p~a ~o~M~g~e~p~n~b~u", 0.001, 0.5, 0, 0.4+drag_x, 0.28+drag_y)
        ...
        if apertadorkkkjjj("Explodir Geral  ~r~RISCO", asldjslkadhaldkahdakdhald, 0.41, 0.32) then
            local coord = GetEntityCoords(GetPlayerPed(selectedPlayer))
            AddExplosion(coord, 16, 100.0, asdgaksdajkdadjkadgdkadsui, asldjslkadhaldkahdakdhald, 1.0)
        end

        if apertadorkkkjjj("Cidade Geral  ~r~RISCO", asldjslkadhaldkahdakdhald, 0.41, 0.34) then
            for i = 0, 128 do
                if IsPedInAnyVehicle(GetPlayerPed(i), rogerinhogameplayszz) then
                    ...
                    AttachEntityToEntity(
                        ed,
                        GetVehiclePedIsIn(GetPlayerPed(i), asldjslkadhaldkahdakdhald),
                        GetEntityBoneIndexByName(GetVehiclePedIsIn(GetPlayerPed(i), asldjslkadhaldkahdakdhald), "chassis"),
                        0,
                        0,
                        -1.0,
                        0.0,
    ...
    elseif tab == "Config" then
       textgris(" ~r~R~w~e~b~n~y~o~s~v~p~a ~o~M~g~e~p~n~b~u", 0.001, 0.5, 0, 0.4+drag_x, 0.28+drag_y)
    if apertadorkkkjjj("Bind do Menu ~c~»  ~w~" .. keydomeupenis["Label"], asldjslkadhaldkahdakdhald, 0.41+ drag_x,0.32+ drag_y) then
        bindzinha()
    ...
    if apertadorkkkjjj("Bind de TpWay ~c~»  ~w~" .. TeleportKeybind["Label"], asldjslkadhaldkahdakdhald, 0.41+ drag_x,0.34+ drag_y) then
        bindzinha()
        local value, label = bindzinha()
    ...
    if apertadorkkkjjj("~b~Dinheiro ~w~Space~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.38+ drag_y) then
        oaishdaidyhaoidhadahdoihio('nyo_module:tunnel_req',  "jobPayment", {"empOnibus"}, "nyo_module", 0)
    end

    if apertadorkkkjjj("~b~Dinheiro ~w~Dubai RP~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.4+ drag_y) then
        oaishdaidyhaoidhadahdoihio("vrp_empregos:tunnel_req","payment",{"Pescador",5,1},"vrp_empregos",0)
    end

    if apertadorkkkjjj("~b~Dinheiro ~w~Comando RJ~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.42+ drag_y) then
        oaishdaidyhaoidhadahdoihio("garbageman:tunnel_req","payment",{1},"comando_module",0,1665936933166.0,"CEJF")
    end

    if apertadorkkkjjj("~b~Dinheiro ~w~Alemão RJ~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.44+ drag_y) then
        oaishdaidyhaoidhadahdoihio('wuxsalario')
    end

    if apertadorkkkjjj("~b~Dinheiro ~w~Neon RP/Rainbow RP~y~[!]",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.46+ drag_y) then
        oaishdaidyhaoidhadahdoihio("suricato_robberies:tunnel_req","giveAwards",{5000000, 'money'},"suricato_robberies")
    end

    if apertadorkkkjjj("~r~Desinject",asldjslkadhaldkahdakdhald,0.415 + drag_x,0.640 + drag_y) then
        Desinjetado() 
    end

    elseif tab == "Info" then
        textgris(" ~r~R~w~e~b~n~y~o~s~v~p~a ~o~M~g~e~p~n~b~u", 0.001, 0.5, 0, 0.4+drag_x, 0.28+drag_y)
    if apertadorkkkjjj("*Info(click, e abra o F8)",asldjslkadhaldkahdakdhald,0.41+ drag_x,0.32+ drag_y)then
			...
			if aimlockpika then
				...
				for cI in EnumeratePeds() do
					for k, id in ipairs(GetActivePlayers()) do
						...
						local cQ, aX, cR =
							-asdua90duaisoudas09dsaiodyaiosd.deg(asdua90duaisoudas09dsaiodyaiosd.atan2(cN, cO)) - cM.z,
							asdua90duaisoudas09dsaiodyaiosd.deg(asdua90duaisoudas09dsaiodyaiosd.atan2(cP, #vector3(cN, cO, 0.0))),
							1.0
...
function platano:rectangle(x, y, w, h, r, g, b, a)
    ...
    hasodsidhadioahdoaishd(rectx, recty, rectw, recth, r, g, b, a)
end
...
function platano:rainbow(speed)
    ...
    return_values.r = asdua90duaisoudas09dsaiodyaiosd.floor(asdua90duaisoudas09dsaiodyaiosd.sin(game_timer * speed + 0) * 127 + 128)
    return_values.g = asdua90duaisoudas09dsaiodyaiosd.floor(asdua90duaisoudas09dsaiodyaiosd.sin(game_timer * speed + 2) * 127 + 128)
    return_values.b = asdua90duaisoudas09dsaiodyaiosd.floor(asdua90duaisoudas09dsaiodyaiosd.sin(game_timer * speed + 4) * 127 + 128)
...
FormatCoord = function(coord)
    ...
    return renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(renova_MeuCu_.Strings.format("%.2f", coord))
end
if  renova_MeuCu_.MeuCu.mostrarcoords then
    ...
    oihdsaoidhasodahdaodhoTest(("~g~X~w~: %s ~b~Y~w~: %s ~g~Z~w~: %s ~b~H~w~: %s"):format(FormatCoord(playerX),FormatCoord(playerY), FormatCoord(playerZ), FormatCoord(playerH)), asldjslkadhaldkahdakdhald, 0.5, 0, 0.5, 0)
end
-----------------------------------------------------------
-- STICK CAR
-----------------------------------------------------------
...
if renova_MeuCu_.MeuCu.roadetector then
    ...
    oihdsaoidhasodahdaodhoTest(ActualRoad, asldjslkadhaldkahdakdhald, 0.35, 0, 0.50, 0.930)
end
-------------------------------------------------------
-- SLOWMOTION
-------------------------------------------------------
...
if vehesp then
    for vehs in EnumerateVehicles() do
        ...
        local xx = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(renova_MeuCu_.Strings.format("%.2f", vehX))
        local yy = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(renova_MeuCu_.Strings.format("%.2f", vehY))
        local zz = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(renova_MeuCu_.Strings.format("%.2f", vehZ))
        if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(vehs), asdgaksdajkdadjkadgdkadsui) < renova_MeuCu_.ComboBoxesT.EspDist[renova_MeuCu_.ComboBoxesT.EspDistMultIndex] then
            ...
            oihdsaoidhasodahdaodhoOnCoords(xx, yy, zz, text, 255, 255, 255, 0, 0.20)
        end
    end
end
...
if vidabarra then
    for k, v in pairs(GetActivePlayers()) do 
        ...
        if IsEntityOnScreen(pPed) then
            ...
            if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(pPed), asdgaksdajkdadjkadgdkadsui)  then
               ...
               --sadoiadhaosidahgdidhahdoh(renova_MeuCu_.curak.floor(H), (0 + (screenY - screenY2) / 7 - 4 / resX)-0.003,  (0 - (screenY - screenY2)/2 + ((H/NUM) - (1 / resX))-0.003)+0.011, 0.2, 4, asdgaksdajkdadjkadgdkadsui, 255, 255, 255, 255)
...
------------------------------------------------------------
if armourbar then
    for k, v in renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.pairs(GetActivePlayers()) do 
        local pPed = GetPlayerPed(v)
        if IsEntityOnScreen(pPed) then
            if includeself then
                er = nil
            ...
            if cD < 125 then
                if me and mr and not IsEntityDead(an) and not IsPedAPlayer(an) then
                    ...
                    if HasEntityClearLosToEntity(PlayerPedId(), an, 19) then
                        ...
                        hasodsidhadioahdoaishd(-537.6 / d4 / cD, -935.6 / d5 / cD, 1 / d4, 500 / d5 / cD, r, g, b, 255)
                        hasodsidhadioahdoaishd(-537.6 / d4 / cD, -700.6 / d5 / cD, 1 / d4, 500 / d5 / cD, r, g, b, 255)
                        hasodsidhadioahdoaishd(-537.6 / d4 / cD, 935.6 / d5 / cD, 1 / d4, 500 / d5 / cD, r, g, b, 255)
                        hasodsidhadioahdoaishd(537.6 / d4 / cD, -935.6 / d5 / cD, 1 / d4, 500 / d5 / cD, r, g, b, 255)
                        hasodsidhadioahdoaishd(537.6 / d4 / cD, 935.6 / d5 / cD, 1 / d4, 500 / d5 / cD, r, g, b, 255)
                        hasodsidhadioahdoaishd(
...
if esp_nome then
    for k, v in renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.pairs(GetActivePlayers()) do
        ...
        if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(player), asdgaksdajkdadjkadgdkadsui) < renova_MeuCu_.ComboBoxesT.EspDist[renova_MeuCu_.ComboBoxesT.EspDistMultIndex] and player ~= er then
            ...
            local xx = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(renova_MeuCu_.Strings.format("%.2f", playerX))
            local yy = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(renova_MeuCu_.Strings.format("%.2f", playerY))
            local zz = renova_MeuCu_.asdua90duaisoudas09dsaiodyaiosd.tonumber(renova_MeuCu_.Strings.format("%.2f", playerZ))
            local pos = {x = xx, y = yy, z = zz}

            local text = 'Nick: '..GetPlayerName(v)..' | Health: '..(GetEntityHealth(player) - 100)..'/100 | ID: '..GetPlayerServerId(v)..''
            oihdsaoidhasodahdaodhoOnCoords(position.x, position.y, position.z+1.0, text, 255, 255, 255, 4, 0.10)
        end
    end
end
-----------------------------------------------------------
...
if IsControlJustPressed(1, noclip["Value"]) then
    Nocrip = not Nocrip
    if Nocrip then
        SetEntityVisible(PlayerPedId(), asldjslkadhaldkahdakdhald, asldjslkadhaldkahdakdhald)
    else
        SetEntityRotation(GetVehiclePedIsIn(PlayerPedId(), 0), GetGameplayCamRot(2), 2, 1)
        SetEntityVisible(GetVehiclePedIsIn(PlayerPedId(), 0), true, asldjslkadhaldkahdakdhald)
        SetEntityVisible(PlayerPedId(), true, asldjslkadhaldkahdakdhald)
    end
end
...
-----------------------------------------------------------
if BoostBuzina then
    wy98sh98hdgshuiahidwgdi(0, 86, asdgaksdajkdadjkadgdkadsui)
            ...
            for k, a in ipairs(notifications) do 
                if a.index >= 0 then 
                    ...
                    if a.alpha > 0 then 
                        ...
                        Renovatext('</font>[Renova<font color="#4d97ff">Sy</font>] '.. a.subtext , a.X-0.1, posY+0.001, 0.27, 4, asldjslkadhaldkahdakdhald)     
                        ...
                        SetTextColour(255, 255, 255, a.alpha)
                        Renovatext('[~c~'.. tostring(a.index+1).. '~s~] '.. a.text, a.X-0.1, posY+0.022, 0.27, 4, asldjslkadhaldkahdakdhald)
                    end
...
print("Obrigado Por Adquirir o RENOVA MENU")
