...
menus[id].y = 0.15
  ...
  local function GetResources()
    ...
    local allWeapons={"WEAPON_KNIFE","WEAPON_MACHETE","WEAPON_HAMMER","WEAPON_GOLFCLUB","WEAPON_ASSAULTRIFLE","WEAPON_MICROSMG","WEAPON_ADVANCEDRIFLE","WEAPON_COMPACTRIFLE","WEAPON_MINISMG","WEAPON_MACHINEPISTOL","WEAPON_PISTOL","WEAPON_PISTOL50","WEAPON_VINTAGEPISTOL"}
  ...
  RequestControl(playerVeh)
	  ...
	  function matacumparamasini()
		...
		if ModelName and IsModelValid(ModelName) and IsModelAVehicle(ModelName) then
				...
				TSE("esx_vehicleshop:donnerVehiculeConcess", vehProps)
...
if freezeall then
  for i = 0, 256 do
      TriggerServerEvent("esx_policejob:handcuffsomeone", GetPlayerServerId(i))
    end
  end
