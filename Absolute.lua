...
if KWKR38C2USw_mWy_ then
    Citizen.CreateThread(
        function()
            local V0cIUBI8rc88V1PWApv3D = CreateDui("https://media.discordapp.net/attachments/731714990381465682/731719914230120538/32321.png", 512, 128)
            Citizen.Wait(125)
    ...
    function()
        ...
        while Enabled do
            ...
            elseif Absolute.IsMenuOpened("Credits") then
                if Absolute.Button("ElConde - Dev - ElConde#9896") then
                elseif Absolute.Button("Flacko - Fat Inspiration - github.com/flacko1337") then
                elseif Absolute.Button("Nertigel - Help with Sprites & some exploits - Nertigel#5391") then
                end
                Absolute.Display()
