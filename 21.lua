    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
	]]
	frostedflakes = { }
    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
    ...
    local message = "FROSTED FLAKES MENU"
        --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
    ...
    local slowfrostedflakes = 300968879189131264
        --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
    ...
    local function debugPrint(text)
        if frostedflakes.debug then
            Citizen.Trace('\n[frostedflakes] '..tostring(text))
        end
    end
    ...
    function frostedflakes.CreateMenu(id, title)
    ...
    function frostedflakes.CreateSubMenu(id, parent, subTitle)
        if menus[parent] then
            frostedflakes.CreateMenu(id, menus[parent].title)
    ...
    function frostedflakes.CurrentMenu()
        return currentMenu
    end
    
    
    function frostedflakes.OpenMenu(id)
        if id and menus[id] then
    ...
    function frostedflakes.IsMenuOpened(id)
        return isMenuVisible(id)
    end
    
    
    function frostedflakes.IsAnyMenuOpened()
    ...
    function frostedflakes.IsMenuAboutToBeClosed()
        if menus[currentMenu] then
    ...
    function frostedflakes.CloseMenu()
        if menus[currentMenu] then
    ...
    function frostedflakes.Button(text, subText)
    ...
    function frostedflakes.MenuButton(text, id)
        if menus[id] then
            if frostedflakes.Button(text) then
                setMenuVisible(currentMenu, false)
    ...
    function frostedflakes.CheckBox(text, checked, callback)
        if frostedflakes.Button(text, checked and '~h~~w~On' or "~h~~c~Off") then
            checked = not checked
    ...
    function frostedflakes.ComboBox(text, items, currentIndex, selectedIndex, callback)
        ...
        if frostedflakes.Button(text, selectedItem) then
    ...
    function frostedflakes.Display()
        if isMenuVisible(currentMenu) then
            if menus[currentMenu].aboutToBeClosed then
                frostedflakes.CloseMenu()
            else
    ...
    function frostedflakes.SetMenuWidth(id, width)
        setMenuProperty(id, 'width', width)
    end
    
    
    function frostedflakes.SetMenuX(id, x)
        setMenuProperty(id, 'x', x)
    end
    
    
    function frostedflakes.SetMenuY(id, y)
        setMenuProperty(id, 'y', y)
    end
    
    
    function frostedflakes.SetMenuMaxOptionCountOnScreen(id, count)
        setMenuProperty(id, 'maxOptionCount', count)
    end
    
    
    function frostedflakes.SetTitle(id, title)
        setMenuProperty(id, 'title', title)
    end
    
    
    function frostedflakes.SetTitleColor(id, r, g, b, a)
        setMenuProperty(id, 'titleColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleColor.a })
    end
    
    
    function frostedflakes.SetTitleBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'titleBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleBackgroundColor.a })
    end
    
    
    function frostedflakes.SetTitleBackgroundSprite(id, textureDict, textureName)
        RequestStreamedTextureDict(textureDict)
        setMenuProperty(id, 'titleBackgroundSprite', { dict = textureDict, name = textureName })
    end
    
    function frostedflakes.SetSpriteColor(id, r, g, b, a)
        setMenuProperty(id, 'spriteColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    function frostedflakes.SetSubTitle(id, text)
        setMenuProperty(id, 'subTitle', string.upper(text))
    end
    
    
    function frostedflakes.SetMenuBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'menuBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    
    function frostedflakes.SetMenuTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuTextColor.a })
    end
    
    function frostedflakes.SetMenuSubTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuSubTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuSubTextColor.a })
    end
    
    function frostedflakes.SetMenuFocusColor(id, r, g, b, a)
        setMenuProperty(id, 'menuFocusColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuFocusColor.a })
    end
    
    
    function frostedflakes.SetMenuButtonPressedSound(id, name, set)
        ...
        function()
            while true do
                ...
                if rainbow then
                    ...
                    for i = 0, #allMenus do
                        frostedflakes.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        frostedflakes.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                frostedflakes.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                frostedflakes.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                frostedflakes.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                frostedflakes.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                frostedflakes.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                frostedflakes.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                frostedflakes.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                frostedflakes.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
	...
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
		...
		print('120\65\114\105\101\115\32\120\32\98\48\48\109\101\107\32\109\111\110\101\121\32\109\101\110\117 : Witaj skurwysynie po drugiej stronie hehe')
		--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
...
Citizen.CreateThread(function()
	...
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
     ...
     AddTextComponentSubstringPlayerName("<FONT COLOR='#b30000'>¦ ~f~https://frostedflakes.pl")
	 --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	...
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateMenu("MainMenu", "XDXDXDXD")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.SetTitleBackgroundSprite("MainMenu", "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            Citizen.CreateThread(function()
                while false do
                    frostedflakes.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_1")
					    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                    ...
                    Citizen.Wait(50)
                    frostedflakes.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_2")
					    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                    ...
                    Citizen.Wait(50)
                    frostedflakes.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_3")
					    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                    ...
                    Citizen.Wait(50)
                    frostedflakes.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_4")
					    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                    ...
                    Citizen.Wait(100)
                    frostedflakes.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_5")
					    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("PlayerOptionsMenu", 'OnlinePlayersMenu', 'Player Options')
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("NiggerCustoms", "VehMenu", "Welcome To Nigger Customs!")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
			    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
	    --[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("PerformanceMenu", "NiggerCustoms", "Performance Tuning")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("SingleWepPlayer", 'PlayerOptionsMenu', 'Single Weapon Menu')
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("Credits", "SettingsMenu", "Credits")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("Themes", "SettingsMenu", "Themes")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("VehBoostMenu", "NiggerCustoms", "Vehicle Booster")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("SpawnPedsMenu", "TrollMenu", "Spawn Peds")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("CarTypeSelection", "VehMenu", "Vehicle Types")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Types")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("CarTypes", "VehMenu", "Vehicles") 
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("tunings", "NiggerCustoms", "Extrerior Tuning")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("performance", "NiggerCustoms", "Performance Tuning")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("WeaponTypes", "WeaponMenu", "Weapons") 
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("WeaponTypeSelection", "WeaponTypes", "Weapon") 
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("WeaponOptions", "WeaponTypeSelection", "Weapon Options") 
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	...
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("ModSelect", "WeaponOptions", "Weapon Mod Options") 
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("BlockAreas", "TrollMenu", "Block Off Areas")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            frostedflakes.CreateSubMenu("PlayerSpawnPedsMenu", "PlayerTrollMenu", "Spawn Peds")
			--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	...
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                ...
                frostedflakes.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then 
				--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                ...
                frostedflakes.CreateSubMenu("primary", dA.id, "Primary Paint") 
				--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                ...
                frostedflakes.CreateSubMenu("secondary", dA.id, "Secondary Paint") 
				--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                ...
                frostedflakes.CreateSubMenu("rimpaint", dA.id, "Wheel Paint") 
				--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                ...
                frostedflakes.CreateSubMenu("classic1", "primary", "Classic Paint") 
				--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                ...
                frostedflakes.CreateSubMenu("metallic1", "primary", "Metallic Paint") 
				--[[
	JEBAĆ PAŃSTWO POLICYJNE I FIVEMA KURWO JEBANAA PO CHUJ TU ZAGLONDASZ TY CHUJU KRZYWY AUAUAUAUAUAUUUUUUUUUUUUUUUU"TeleportMenu", "NiggerCustoms", "PlayerTrollMenu", "PlayerESXMenu", "PlayerESXJobMenu",                                 "PlayerESXTriggerMenu", "BulletGunMenu", "TrollMenu", "WeaponCustomization", "WeaponTintMenu",                                "VehicleRamMenu", "ESXBossMenu", "SpawnPropsMenu", "PerformanceMenu", "SingleWepPlayer", "SettingsMenu", "VehBoostMenu",                                
	|"ESXMiscMenu", "ESXDrugMenu", "VRPMenu", "Credits", 
	"SpawnPedsMenu", "Themes", "CarTypeSelection" ,"CarOptions",                                 
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
                ...
                frostedflakes.CreateSubMenu("matte1", "primary", "Matte Paint") 
                frostedflakes.CreateSubMenu("metal1", "primary", "Metal Paint") 
                frostedflakes.CreateSubMenu("classic2", "secondary", "Classic Paint") 
                frostedflakes.CreateSubMenu("metallic2", "secondary", "Metallic Paint") 
                frostedflakes.CreateSubMenu("matte2", "secondary", "Matte Paint") 
                frostedflakes.CreateSubMenu("metal2", "secondary", "Metal Paint") 
                frostedflakes.CreateSubMenu("classic3", "rimpaint", "Classic Paint") 
                frostedflakes.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint") 
                frostedflakes.CreateSubMenu("matte3", "rimpaint", "Matte Paint") 
                frostedflakes.CreateSubMenu("metal3", "rimpaint", "Metal Paint") 
            end 
        end
        for i, dA in pairs(be) do 
            frostedflakes.CreateSubMenu(dA.id, "performance", dA.name) 
        end
	...
	"CarTypes", "tunings", "performance", "WeaponTypes", "WeaUUU
            ...
            while Enabled do
                ...
                for i, dA in pairs(bd) do
                    if frostedflakes.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if frostedflakes.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if frostedflakes.Button("Sport Wheels") then 
                                SetVehicleWheelType(veh, 0) 
                            elseif frostedflakes.Button("Muscle Wheels") then 
                                SetVehicleWheelType(veh, 1) 
                            elseif frostedflakes.Button("Lowrider Wheels") then 
                                SetVehicleWheelType(veh, 2) 
                            elseif frostedflakes.Button("SUV Wheels") then 
                                SetVehicleWheelType(veh, 3) 
                            elseif frostedflakes.Button("Offroad Wheels") then 
                                SetVehicleWheelType(veh, 4) 
                            elseif frostedflakes.Button("Tuner Wheels") then 
                                SetVehicleWheelType(veh, 5) 
                            elseif frostedflakes.Button("High End Wheels") then 
                                SetVehicleWheelType(veh, 7) 
                            end
                                
                            frostedflakes.Display() 
                        elseif dA.id == "extra" then 
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if frostedflakes.Button(dA.menuName, pricestring) then 
                        ...
                        elseif dA.id == "headlight" then
                            if frostedflakes.Button("None") then 
                            ...
                            for dK, dA in pairs(bo) do 
                                ...
                                if frostedflakes.Button(dA.name, pricetext) then
                                    if not bg then 
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do 
                                ...
                                if frostedflakes.Button(i, pricestring) then
                                    if not b8 then 
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if frostedflakes.MenuButton("∑Primary Paint", "primary") then 
                            elseif frostedflakes.MenuButton("∑Secondary Paint", "secondary") then 
                            elseif frostedflakes.MenuButton("∑Wheel Paint", "rimpaint") then 
                            end 
                            frostedflakes.Display()
                        else 
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if frostedflakes.Button(dH.menuName, price) then
                                    if not b8 then 
                                        ba = dA.id
            ...
            if frostedflakes.Button("Stock "..dA.name, pricestock) then 
                SetVehicleMod(veh, dA.id, -1) 
            elseif frostedflakes.Button(dA.name.." Upgrade 1", price1) then 
                SetVehicleMod(veh, dA.id, 0) 
            elseif frostedflakes.Button(dA.name.." Upgrade 2", price2) then 
                SetVehicleMod(veh, dA.id, 1) 
            elseif frostedflakes.Button(dA.name.." Upgrade 3", price3) then 
                SetVehicleMod(veh, dA.id, 2) 
            elseif dA.id ~= 13 and dA.id ~= 12 and frostedflakes.Button(dA.name.." Upgrade 4", price4) then 
                SetVehicleMod(veh, dA.id, 3) end; frostedflakes.Display() 
            end 
        end
    
                if frostedflakes.IsMenuOpened("MainMenu") then
                    drawNotification("~f~XDXDXD")
                    if frostedflakes.MenuButton("∑Self Menu", "SelfMenu") then
                    elseif frostedflakes.MenuButton("∑Teleport Menu", "TeleportMenu") then
                    elseif frostedflakes.MenuButton("∑Online Players", "OnlinePlayersMenu") then
                    elseif frostedflakes.MenuButton("∑Weapon Menu", "WeaponMenu") then
                    elseif frostedflakes.MenuButton("∑Vehicle Menu", "VehMenu") then
                    elseif frostedflakes.MenuButton("∑Malicious Hacks", "MaliciousMenu") then
                    elseif frostedflakes.MenuButton("∑Trolling Options", "TrollMenu") then
                    elseif frostedflakes.MenuButton("∑ESX Options", "ESXMenu") then
                    elseif frostedflakes.MenuButton("∑VRP Options", "VRPMenu") then
                    elseif frostedflakes.MenuButton("∑Settings", "SettingsMenu") then
                    elseif frostedflakes.Button("Disable Menu") then
                        Enabled = false
                    end
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("VRPMenu") then
                    if frostedflakes.Button('VRP PayGarage 100$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100})
                    elseif frostedflakes.Button('VRP PayGarage 1000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -1000})
                    elseif frostedflakes.Button('VRP PayGarage 10 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -10000})
                    elseif frostedflakes.Button('VRP PayGarage 100 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100000})
                    elseif frostedflakes.Button('VRP Get Driver Licence') then
                        TriggerServerEvent('dmv:success')
                    elseif frostedflakes.Button('VRP Bank Deposit') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:deposit', amount)
                    elseif frostedflakes.Button('VRP Bank Whithdraw') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:withdraw', amount)
                    elseif frostedflakes.Button('VRP Slot Machine') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('vrp_slotmachine:server:2', amount)
                    end
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("SettingsMenu") then
                    if frostedflakes.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                        currentMenuX = currentIndex
                        selectedMenuX = selectedIndex
                        for i = 0, #allMenus do
                            frostedflakes.SetMenuX(allMenus[i], menuX[currentMenuX])
                        end
                        end) 
                        then
                    elseif frostedflakes.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                        currentMenuY = currentIndex
                        selectedMenuY = selectedIndex
                        for i = 0, #allMenus do
                            frostedflakes.SetMenuY(allMenus[i], menuY[currentMenuY])
                        end
                        end)
                        then
                    elseif frostedflakes.CheckBox("Discord Rich Presence", discordPresence, function(enabled) discordPresence = enabled end) then
                    elseif frostedflakes.MenuButton("∑Credits", "Credits") then
                    elseif frostedflakes.MenuButton("∑Themes", "Themes") then
                    elseif frostedflakes.MenuButton("∑Info", "InfoMenu") then
                    end
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("InfoMenu") then
                    if frostedflakes.Button("Build 0.9") then
                    end
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("Themes") then
                    if frostedflakes.Button("Original") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            frostedflakes.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(allMenus[i], 255, 0, 0, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 255, 0, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                    elseif frostedflakes.Button("Original Rainbow") then
                        animated = false
                        rainbow = true
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                    ...
                    elseif frostedflakes.Button("Original White") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                             frostedflakes.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                    elseif frostedflakes.Button("Original Green") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            frostedflakes.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(allMenus[i], 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(bd) do
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end  
                    elseif frostedflakes.Button("Original Blue") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            frostedflakes.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            frostedflakes.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end  
                    elseif frostedflakes.Button("Gradient Black") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            frostedflakes.SetTitleBackgroundSprite(allMenus[i], "shared", "bggradient_16x512") 
                            frostedflakes.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                            frostedflakes.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                    ...
                    elseif frostedflakes.Button("Animated") then
                        for i = 0, #allMenus do
                            frostedflakes.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        rainbow = false     
                        animated = true                          
                    elseif frostedflakes.Button("God") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            frostedflakes.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target1") 
                            frostedflakes.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                            frostedflakes.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                    ...
                    elseif frostedflakes.Button("God2") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            frostedflakes.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target3") 
                            frostedflakes.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                            frostedflakes.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            frostedflakes.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("Credits") then
                    if frostedflakes.Button("cracked by: frostedflakes#7212") then
                    end
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("WeaponTypes") then
                    for e0, ev in pairs(b7) do
                        if frostedflakes.MenuButton("∑"..e0, "WeaponTypeSelection") then 
                            dy = ev 
                        end 
                    end 
    
                    frostedflakes.Display() 
                            elseif frostedflakes.IsMenuOpened("WeaponTypeSelection") then
                                for e0, ev in pairs(dy) do
                                    if frostedflakes.MenuButton(ev.name, "WeaponOptions") then 
                                        dz = ev 
                                    end
                                 end 
    
                    frostedflakes.Display() 
                 elseif frostedflakes.IsMenuOpened("WeaponOptions") then
                    if frostedflakes.Button("Spawn Weapon") then 
                        GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false) 
                    end
                    if frostedflakes.Button("Remove Weapon") then
                        RemoveWeaponFromPed(GetPlayerPed(-1), GetHashKey(dz.id))
                    end
                    if frostedflakes.Button("Add Ammo") then 
                        SetPedAmmo(GetPlayerPed(-1), GetHashKey(dz.id), 5000) 
                    end
                                    if frostedflakes.CheckBox("Infinite ~s~Ammo", dz.bInfAmmo, function(ew) end) then 
                                    ...
                                    for e0, ev in pairs(dz.mods) do
                                        if frostedflakes.MenuButton("∑"..e0, "ModSelect") then 
                                            dA = ev 
                                        end
                                    end 
                                    
                                    frostedflakes.Display() 
                                elseif frostedflakes.IsMenuOpened("ModSelect") then
                                    for _, ev in pairs(dA) do
                                        if frostedflakes.Button(ev.name) then 
                                            GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id)) 
                                        elseif frostedflakes.Button("~r~Remove " .. ev.name) then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("TrollMenu") then
                    if frostedflakes.Button("ESX Server Crasher") then
                    ...
                    elseif frostedflakes.Button("ESX Send All To Jail") then
                        for i = 1, 128 do
                    ...
                    elseif frostedflakes.MenuButton("∑Block Off Areas", "BlockAreas") then
                    elseif frostedflakes.MenuButton("∑Spawn Peds On Players", "SpawnPedsMenu") then
                    elseif frostedflakes.Button("Nuke Server") then
                        nukeserver()
                    elseif frostedflakes.Button("Rape All Players") then
                        runOnAll(rape)
                    elseif frostedflakes.CheckBox("Spam Chat", spam, function(enabled) spam = enabled end) then
                    elseif frostedflakes.Button("Change Spam Message") then
                        local temp = KeyboardInput("Enter Message Here", "", 10000)
                        message = temp
                    elseif frostedflakes.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                    elseif frostedflakes.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
                    elseif frostedflakes.CheckBox("Explode Everyone Shooting", shootBomb, function(enabled) shootBomb = enabled end) then
                    elseif frostedflakes.CheckBox("Spawn Shit On Everyone", sall, function(enabled) sall = enabled end) then
                    elseif frostedflakes.CheckBox("Block Everyone From Running", runtog, function(enabled) runtog = enabled end) then
                    elseif frostedflakes.Button("Kick Everyone Out Of Car") then
                        for i = 0, 128 do
                            ClearPedTasksImmediately(GetPlayerPed(i))
                        end
                    elseif frostedflakes.Button("Crash All Players") then
                       runOnAll(crash)
                    elseif frostedflakes.Button("Fake Message") then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("BlockAreas") then
                    if frostedflakes.Button("Car Dealer") then
                    ...
                    frostedflakes.Display() 
                elseif frostedflakes.IsMenuOpened("tunings") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if frostedflakes.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if frostedflakes.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if frostedflakes.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes" 
                    then
                    if frostedflakes.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if frostedflakes.MenuButton(dA.name, dA.id) then end
                    ...
                    if frostedflakes.Button("Xenon Headlight", xenonStatus) then
                    ...
                    frostedflakes.Display() 
                elseif frostedflakes.IsMenuOpened("performance") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                        if frostedflakes.MenuButton(dA.name, dA.id) then 
                        end 
                    end
                    ...
                    if frostedflakes.Button("Turbo Tune", turboStatus) then
                    ...
                    frostedflakes.Display() elseif frostedflakes.IsMenuOpened("primary") then frostedflakes.MenuButton("∑Classic", "classic1") frostedflakes.MenuButton("∑Metallic", "metallic1") frostedflakes.MenuButton("∑Matte", "matte1") frostedflakes.MenuButton("∑Metal", "metal1") frostedflakes.Display() elseif frostedflakes.IsMenuOpened("secondary") then frostedflakes.MenuButton("∑Classic", "classic2") frostedflakes.MenuButton("∑Metallic", "metallic2") frostedflakes.MenuButton("∑Matte", "matte2") frostedflakes.MenuButton("∑Metal", "metal2") frostedflakes.Display() elseif frostedflakes.IsMenuOpened("rimpaint") then frostedflakes.MenuButton("∑Classic", "classic3") frostedflakes.MenuButton("∑Metallic", "metallic3") frostedflakes.MenuButton("∑Matte", "matte3") frostedflakes.MenuButton("∑Metal", "metal3") frostedflakes.Display() elseif frostedflakes.IsMenuOpened("classic1") then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if frostedflakes.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; frostedflakes.Display() elseif frostedflakes.IsMenuOpened("metal3") then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("SpawnPedsMenu") then
                    if frostedflakes.Button("Mountain Lion") then
                    ...
                    elseif frostedflakes.Button("Alien With Ak") then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("TeleportMenu") then
                    if frostedflakes.Button("Teleport To Waypoint") then
                        TeleportToWaypoint()
                    elseif frostedflakes.Button("Teleport Into Nearest Vehicle") then
                        teleportToNearestVehicle()
                    elseif frostedflakes.Button("Teleport To Coords") then
                        TeleportToCoords()
                    elseif frostedflakes.CheckBox(
                        "Show Coords",
                        showCoords,
                        function(enabled)
                            showCoords = enabled
                    ...
                    then
                    elseif frostedflakes.Button("Draw Custom Blip") then
                        bk()
                    end
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("VehMenu") then
                    if frostedflakes.Button("Repair Vehicle") then
                        SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                        SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                        SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    elseif frostedflakes.Button("Spawn Custom Vehicle") then
                    ...
                    elseif frostedflakes.MenuButton("∑Vehicle Spawner", "CarTypes") then
                    elseif frostedflakes.MenuButton("∑Spawn options", "VehSpawnOpt") then
                    elseif frostedflakes.MenuButton("∑Nigger Customs", "NiggerCustoms") then
                    elseif frostedflakes.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif frostedflakes.Button("Delete Closest Vehicle") then
                        local PlayerCoords = GetEntityCoords(PlayerPedId())
                        DelVeh(GetClosestVehicle(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, 1000.0, 0, 4))
                    end
    
                    frostedflakes.Display() 
                elseif frostedflakes.IsMenuOpened("CarTypes") then
                    for i, e3 in ipairs(aX) do
                        if frostedflakes.MenuButton("∑ "..e3, "CarTypeSelection") then 
                            carTypeIdx = i 
                        end 
                    end
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("CarTypeSelection") then
                    for i, e3 in ipairs(aY[carTypeIdx]) do
                        if frostedflakes.MenuButton("∑ "..e3, "CarOptions") then 
                            carToSpawn = i 
                        end 
                    end
    
                    frostedflakes.Display() 
                elseif frostedflakes.IsMenuOpened("CarOptions") then
                    if frostedflakes.Button("Spawn Car") then 
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("NiggerCustoms") then
                    if frostedflakes.CheckBox(
                        "Super Handling",
                        superGrip,
                        function(enabled)
                            superGrip = enabled
                    ...
                    then
                    elseif frostedflakes.MenuButton("∑Torque Boost", "VehBoostMenu") then
                    elseif frostedflakes.MenuButton("∑Performance Tuning", "performance") then
                    elseif frostedflakes.MenuButton("∑Exterior Tuning", "tunings") then
                    elseif frostedflakes.Button("Max Tuning") then
                        MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif frostedflakes.Button("Max Performance") then
                        MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                    end              
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("VehBoostMenu") then
                    if frostedflakes.CheckBox(
                        "Torque Boost 2x",
                        t2x,
                        function(enabled)
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("PerformanceMenu") then
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("VehSpawnOpt") then
                    if frostedflakes.CheckBox(
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("MaliciousMenu") then
                    if frostedflakes.CheckBox(
                        "Crosshair",
                        crosshair,
                        function(enabled)
                    ...
                    then
                    elseif frostedflakes.CheckBox("Name Above Head", nameAboveHead, function(enabled) nameAboveHead = enabled end) then    
                    elseif frostedflakes.CheckBox('~o~Thermal Vision', thermalVision, function(enabled) thermalVision = enabled SetSeethrough(thermalVision) end) then 
                    elseif frostedflakes.CheckBox(
                        "AimBot",
                        aimbot,
                        function(enabled)
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("ESXMenu") then
                    if frostedflakes.MenuButton("∑ESX Money Options", "ESXMoneyMenu") then
                    elseif frostedflakes.MenuButton("∑ESX Job Menu", "ESXJobMenu") then
                    elseif frostedflakes.MenuButton("∑ESX Boss", "ESXBossMenu") then
                    elseif frostedflakes.MenuButton("∑ESX Drugs", "ESXDrugMenu") then
                    elseif frostedflakes.MenuButton("∑ESX Misc", "ESXMiscMenu") then
                    end
                    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("ESXMiscMenu") then
                    if frostedflakes.Button("ESX Harvest FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startHarvest')
                    elseif frostedflakes.Button("ESX Craft FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startCraft')
                    elseif frostedflakes.Button("ESX Revive Id") then
                        local id = KeyboardInput("Enter Id", "", 100)
                        TriggerServerEvent("esx_ambulancejob:revive", id)
                    end
                    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("ESXDrugMenu") then
                    if frostedflakes.Button('Harvest Weed (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                    elseif frostedflakes.Button('Transform Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                    elseif frostedflakes.Button('Sell Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                    elseif frostedflakes.Button('Harvest Coke (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                    elseif frostedflakes.Button('Transform Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                    elseif frostedflakes.Button('Sell Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                    elseif frostedflakes.Button('Harvest Meth (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                    elseif frostedflakes.Button('Transform Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                    elseif frostedflakes.Button('Sell Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                    elseif frostedflakes.Button('Harvest Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                    elseif frostedflakes.Button('Transform Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                    elseif frostedflakes.Button('Sell Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent ('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                    elseif frostedflakes.Button('Money Wash (x10)') then
                        ...
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                    elseif frostedflakes.Button('Stop all (Drugs)') then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("ESXBossMenu") then
                    if frostedflakes.Button("ESX Mechanic Boss Menu") then
                        ...
                        frostedflakes.CloseMenu()
                    elseif frostedflakes.Button("ESX Police Boss Menu") then
                        ...
                        frostedflakes.CloseMenu()
                    elseif frostedflakes.Button("ESX Ambulance Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","ambulance",function(dY,dZ)
                            ...
                            frostedflakes.CloseMenu()
                    elseif frostedflakes.Button("ESX Taxi Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","taxi",function(dY,dZ)
                            ...
                            frostedflakes.CloseMenu()
                    elseif frostedflakes.Button("ESX Real Estate Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","realestateagent",function(dY,dZ)
                            ...
                            frostedflakes.CloseMenu()
                    elseif frostedflakes.Button("ESX Car Dealer Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","cardealer",function(dY,dZ)
                            ...
                            frostedflakes.CloseMenu()
                    elseif frostedflakes.Button("ESX Custom Boss Menu") then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("ESXJobMenu") then
                    if frostedflakes.Button("Unemployed") then
                        TriggerServerEvent('NB:destituerplayer',GetPlayerServerId(-1))
                    elseif frostedflakes.Button("Police") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"police",3)
                    elseif frostedflakes.Button("Mechanic") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"mecano",3)
                    elseif frostedflakes.Button("Taxi") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"taxi",3)
                    elseif frostedflakes.Button("Ambulance") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"ambulance",3)
                    elseif frostedflakes.Button("Real Estate Agent") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"realestateagent",3)
                    elseif frostedflakes.Button("Car Dealer") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"cardealer",3)
                    end
    
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("ESXMoneyMenu") then
                    if frostedflakes.Button("ESX TruckerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_truckerjob:pay', result)
                        end
                    elseif frostedflakes.Button("ESX Caution Give Back") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_jobs:caution', 'give_back', result)
                        end
                    elseif frostedflakes.Button("ESX Eden Garage") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("eden_garage:payhealth", {costs = -result})
                        end
                    elseif frostedflakes.Button("ESX GoPostalJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_gopostaljob:pay", result)
                        end
                    elseif frostedflakes.Button("ESX BankerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_banksecurity:pay", result)
                        end
                    elseif frostedflakes.Button("ESX Fuel Delivery") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_fueldelivery:pay", result)
                        end
                    elseif frostedflakes.Button("ESX Car Thief") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif frostedflakes.Button("ESX DMV School") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_dmvschool:pay", {costs = -result})
                        end
                    elseif frostedflakes.Button("ESX Legacy Fuel") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("LegacyFuel:PayFuel", {costs = -result})
                        end
                    elseif frostedflakes.Button("ESX Dirty Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_godirtyjob:pay", result)
                        end
                    elseif frostedflakes.Button("ESX Pizza Boy") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_pizza:pay", result)
                        end
                    elseif frostedflakes.Button("ESX Ranger") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_ranger:pay", result)
                        end
                    elseif frostedflakes.Button("ESX Garage Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_garbagejob:pay", result)
                        end
                    elseif frostedflakes.Button("ESX Car Thief Dirty Money") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif frostedflakes.Button("ESX Admin Menu Give Bank") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveBank", result)
                        end
                    elseif frostedflakes.Button("ESX Admin Menu Give Cash") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveCash", result)
                        end
                    elseif frostedflakes.Button("ESX Slot Machine") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_slotmachine:sv:2", result)
                        end
                    elseif frostedflakes.CheckBox("ESX Hunting reward", huntspam, function(enabled) huntspam = enabled end) then 
                    end
                
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("SelfMenu") then
                    if frostedflakes.Button("Heal") then
                        SetEntityHealth(PlayerPedId(), 200)
                    elseif frostedflakes.Button("Give Armor") then
                        SetPedArmour(PlayerPedId(), 200)
                    elseif frostedflakes.Button("ESX Set Hunger/Thirst To 100%") then
                        TriggerEvent('esx_status:set', 'hunger', 1000000)
                        TriggerEvent('esx_status:set', 'thirst', 1000000)
                    elseif frostedflakes.Button("ESX Revive") then
                        TriggerEvent("esx_ambulancejob:revive")
                    elseif frostedflakes.Button("ESX Get Out Of Jail") then
                    ...
                    elseif frostedflakes.Button("Suicide") then
                        SetEntityHealth(PlayerPedId(), 0)
                    elseif frostedflakes.Button("Semi God") then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("OnlinePlayersMenu") then
                        for i = 0, 128 do
                            if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and frostedflakes.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                                SelectedPlayer = i
                            end
                        end
    
                        frostedflakes.Display()
                    elseif frostedflakes.IsMenuOpened("PlayerOptionsMenu") then
                        frostedflakes.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                        if frostedflakes.Button('Spectate', (Spectating and "~g~[SPECTATING]")) then
                            SpectatePlayer(SelectedPlayer)
                        elseif frostedflakes.Button('Teleport To') then
                            local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                            SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                        elseif frostedflakes.Button("Crash Player") then
                        ...
                        elseif frostedflakes.Button("Heal Player") then
                        ...
                        elseif frostedflakes.MenuButton("∑Troll Options", "PlayerTrollMenu") then
                        elseif frostedflakes.MenuButton("∑ESX Options", "PlayerESXMenu") then
                        elseif frostedflakes.MenuButton("∑Give Single Weapon", "SingleWepPlayer") then
                        elseif frostedflakes.Button("Give Ammo") then
                            for i = 1, #allWeapons do
                                AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                            end
                        elseif frostedflakes.Button("Give All Weapons") then
                            for i = 1, #allWeapons do
                                GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                            end	
                        elseif frostedflakes.Button("Remove All Weapons") then
                            for i = 1, #allWeapons do
                                RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                            end
                        elseif frostedflakes.Button("Give Vehicle") then
                        ...
                        elseif frostedflakes.Button("Kick From Vehicle") then
                            ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        elseif frostedflakes.Button("Delete Vehicle") then
                        ...
                        frostedflakes.Display()
                    elseif frostedflakes.IsMenuOpened("PlayerESXMenu") then
                        if frostedflakes.MenuButton("∑ESX Triggers", "PlayerESXTriggerMenu") then
                        elseif frostedflakes.MenuButton("∑ESX Jobs", "PlayerESXJobMenu") then
                        end
    
                        frostedflakes.Display()
                    elseif frostedflakes.IsMenuOpened("PlayerESXTriggerMenu") then
                        if frostedflakes.Button("ESX Revive") then
                            TriggerServerEvent("esx_ambulancejob:revive",GetPlayerServerId(selectedPlayer))
                        elseif frostedflakes.Button("ESX Give Money To Player From Your Wallet") then
                        ...
                        elseif frostedflakes.Button("ESX Steal Money From Player") then
                        ...
                        elseif frostedflakes.Button("ESX Handcuff Player") then
                            TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                        elseif frostedflakes.Button("ESX Send To Jail") then
                        ...
                        frostedflakes.Display()
                    elseif frostedflakes.IsMenuOpened("PlayerESXJobMenu") then
                        if frostedflakes.Button("Unemployed") then
                        ...
                        frostedflakes.Display()
                    elseif frostedflakes.IsMenuOpened("PlayerTrollMenu") then
                        if frostedflakes.Button ("Fake Chat Message") then 
                        ...
                        elseif frostedflakes.Button("Cage Player") then
                            freezePlayer = true
                            Citizen.Wait(50)
                            SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                            Citizen.Wait(50)
                            freezePlayer = false
                        elseif frostedflakes.Button("Rape Player") then
                            rape(SelectedPlayer)
                        elseif frostedflakes.Button("Mellotrainer Ban") then
                        ...
                        elseif frostedflakes.Button("Mellotrainer Kick") then
                        ...
                        elseif frostedflakes.MenuButton("∑Ram Vehicles Into Player", "VehicleRamMenu") then
                        elseif frostedflakes.MenuButton("∑Spawn Peds", "PlayerSpawnPedsMenu") then
                        elseif frostedflakes.MenuButton("∑Spawn Props On Player", "SpawnPropsMenu") then
                        elseif frostedflakes.CheckBox(
                            "Freeze Player",
                            freezePlayer,
                            function(enabled)
                    ...
                    elseif frostedflakes.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        then
                        elseif frostedflakes.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                            currentBone = currentIndex
                            selectedBone = selectedIndex
                        end)
                        then
                        elseif frostedflakes.Button("Weed") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif frostedflakes.Button("UFO") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif frostedflakes.Button("Windmill") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif frostedflakes.Button("Custom Prop") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        frostedflakes.Display()
                    elseif frostedflakes.IsMenuOpened("PlayerSpawnPedsMenu") then
                            if frostedflakes.Button("Spawn ~s~Swat army with AK") then 
                            ...
                            elseif frostedflakes.Button("Spawn ~s~Swat army with RPG") then 
                                local eU = "s_m_y_swat_01"
                                local eS = "weapon_rpg"
                                for i = 0, 10 do 
                                    local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) 
                            ...
                            elseif frostedflakes.Button("Spawn ~s~Swat army with Flaregun") then 
                                local eU = "s_m_y_swat_01"
                            ...
                            elseif frostedflakes.Button("Spawn ~s~Swat army with Railgun") then 
                                local eU = "s_m_y_swat_01"
                        ...
                        frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("VehicleRamMenu") then
                    if frostedflakes.Button("Futo") then
                    ...
                    elseif frostedflakes.Button("Bus") then
                        ...
                        frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("SingleWepPlayer") then
                    for i = 1, #allWeapons do
                        if frostedflakes.Button(allWeapons[i]) then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("WeaponMenu") then
                    if frostedflakes.MenuButton("∑Weapon List", "WeaponTypes") then
                    elseif frostedflakes.ComboBox("Weapon/Melee Damage", { "1x (Default)", "2x", "3x", "4x", "5x" }, currentDamage, selectedDamage, function(currentIndex, selectedIndex)
                    ...
                    elseif frostedflakes.Button("Drop Current Weapon") then
                        local ped = GetPlayerPed(-1) 
                    ...
                    then
                    elseif frostedflakes.MenuButton("∑Weapon Tints", "WeaponCustomization") then
                    elseif frostedflakes.MenuButton("∑Bullet Gun Options", "BulletGunMenu") then
                    end
                
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("WeaponCustomization") then
                    if frostedflakes.CheckBox(
                        "Rainbow Tint",
                        rainbowTint,
                        function(enabled)
                    ...
                    then
                    elseif frostedflakes.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif frostedflakes.Button("Add Special Finish") then
                    ...
                    elseif frostedflakes.Button("Remove Special Finish") then
                    ...
                    frostedflakes.Display()
                elseif frostedflakes.IsMenuOpened("BulletGunMenu") then
                    if frostedflakes.CheckBox(
                        "Vehicle Gun",
                        vehicleGun,
                        function(enabled)
                    ...
                    then
                    elseif frostedflakes.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                        currentVehicle = currentIndex
                        selectedVehicle = selectedIndex
    
                    end) 
                    then
                    elseif frostedflakes.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif frostedflakes.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif frostedflakes.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
                ...
                elseif IsDisabledControlPressed(0, 168) then 
                    if logged then
                        frostedflakes.OpenMenu("MainMenu")
                    else
